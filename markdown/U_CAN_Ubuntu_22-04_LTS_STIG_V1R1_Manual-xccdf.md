...
### Rule: Ubuntu 22.04 LTS must deploy an Endpoint Security Solution.

**Rule ID:** `SV-260468r954041_rule`
**Severity:** medium
...
### Rule: Ubuntu 22.04 LTS must allow the use of a temporary password for system logons with an immediate change to a permanent password.

**Rule ID:** `SV-260544r954045_rule`
**Severity:** medium
...
### Rule: Ubuntu 22.04 LTS must enforce 24 hours/1 day as the minimum password lifetime. Passwords for new users must have a 24 hours/1 day minimum password lifetime restriction.
...
### Rule: Ubuntu 22.04 LTS must display the date and time of the last successful account logon upon logon.
...
### Rule: Ubuntu 22.04 LTS must prohibit password reuse for a minimum of five generations.
