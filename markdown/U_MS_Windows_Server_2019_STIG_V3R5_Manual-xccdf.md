...
**Rule ID:** `SV-205650r1107646_rule`
**Severity:** medium
...
**Rule ID:** `SV-205663r1106629_rule`
**Severity:** high
...
**Rule ID:** `SV-205747r1106518_rule`
**Severity:** medium
...
### Rule: Windows Server 2019 must be configured for certificate-based authentication for domain controllers.
...
### Rule: Windows Server 2019 must be configured for named-based strong mappings for certificates.

**Rule ID:** `SV-271429r1106520_rule`
**Severity:** medium
