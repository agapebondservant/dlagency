# STIG Benchmark: Cisco IOS Router NDM Security Technical Implementation Guide
...
### Rule: The Cisco router must be configured to enforce password complexity by requiring that at least one upper-case character be used.

**Rule ID:** `SV-215682r879603_rule`
**Severity:** medium
...
### Rule: The Cisco router must be configured to enforce password complexity by requiring that at least one lower-case character be used.

**Rule ID:** `SV-215683r879604_rule`
**Severity:** medium
...
### Rule: The Cisco router must be configured to send log data to at least two syslog servers for the purpose of forwarding alerts to the administrators and the ISSO.
