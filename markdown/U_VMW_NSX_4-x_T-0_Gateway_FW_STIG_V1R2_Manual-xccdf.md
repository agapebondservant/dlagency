# STIG Benchmark: VMware NSX 4.x Tier-0 Gateway Firewall Security Technical Implementation Guide
...
### Rule: The NSX Tier-0 Gateway Firewall must generate traffic log entries.

**Rule ID:** `SV-265362r994329_rule`
**Severity:** medium
...
### Rule: The NSX Tier-0 Gateway Firewall must manage excess bandwidth to limit the effects of packet flooding types of denial-of-service (DoS) attacks.

**Rule ID:** `SV-265367r994344_rule`
**Severity:** high
...
### Rule: The NSX Tier-0 Gateway Firewall must deny network communications traffic by default and allow network communications traffic by exception.

**Rule ID:** `SV-265368r994347_rule`
**Severity:** medium
...
### Rule: The NSX Tier-0 Gateway Firewall must be configured to send traffic log entries to a central log server.

**Rule ID:** `SV-265370r994353_rule`
**Severity:** medium
