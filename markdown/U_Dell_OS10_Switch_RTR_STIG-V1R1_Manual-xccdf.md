# STIG Benchmark: Dell OS10 Switch Router Security Technical Implementation Guide
...
### Rule: The Dell OS10 Router must be configured to enforce approved authorizations for controlling the flow of information within the network based on organization-defined information flow control policies.

**Rule ID:** `SV-269849r1051932_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to reject inbound route advertisements for any Bogon prefixes.

**Rule ID:** `SV-269850r1051935_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to reject inbound route advertisements for any prefixes belonging to the local autonomous system (AS).

**Rule ID:** `SV-269851r1051938_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to reject inbound route advertisements from a customer edge (CE) router for prefixes that are not allocated to that customer.

**Rule ID:** `SV-269852r1051941_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to reject outbound route advertisements for any prefixes that do not belong to any customers or the local autonomous system (AS).

**Rule ID:** `SV-269853r1051944_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to reject route advertisements from BGP peers that do not list their autonomous system (AS) number as the first AS in the AS_PATH attribute.

**Rule ID:** `SV-269854r1051947_rule`
**Severity:** low
...
### Rule: The Dell OS10 BGP router must be configured to reject route advertisements from CE routers with an originating autonomous system (AS) in the AS_PATH attribute that does not belong to that customer.

**Rule ID:** `SV-269855r1051950_rule`
**Severity:** low
...
### Rule: The Dell OS10 multicast router must be configured to disable Protocol Independent Multicast (PIM) on all interfaces that are not required to support multicast routing.

**Rule ID:** `SV-269857r1051956_rule`
**Severity:** medium
...
### Rule: The Dell OS10 multicast router must be configured to bind a Protocol Independent Multicast (PIM) neighbor filter to interfaces that have PIM enabled.

**Rule ID:** `SV-269858r1051959_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must be configured to have all inactive interfaces disabled.

**Rule ID:** `SV-269859r1051962_rule`
**Severity:** low
...
### Rule: The perimeter router must be configured to not be a Border Gateway Protocol (BGP) peer to an alternate gateway service provider.

**Rule ID:** `SV-269861r1052431_rule`
**Severity:** high
...
### Rule: The Dell OS10 out-of-band management (OOBM) gateway router must be configured to have separate Interior Gateway Protocol (IGP) instances for the managed network and management network.

**Rule ID:** `SV-269863r1052433_rule`
**Severity:** medium
...
### Rule: The Dell OS10 out-of-band management (OOBM) gateway router must be configured to not redistribute routes between the management network routing domain and the managed network routing domain.

**Rule ID:** `SV-269864r1051977_rule`
**Severity:** medium
...
### Rule: The Dell OS10 multicast Rendezvous Point (RP) router must be configured to filter Protocol Independent Multicast (PIM) Register messages received from the Designated Router (DR) for any undesirable multicast groups and sources.

**Rule ID:** `SV-269865r1051980_rule`
**Severity:** low
...
### Rule: The Dell OS10 multicast Rendezvous Point (RP) router must be configured to filter Protocol Independent Multicast (PIM) Join messages received from the Designated Router (DR) for any undesirable multicast groups.

**Rule ID:** `SV-269866r1051983_rule`
**Severity:** low
...
### Rule: The Dell OS10 Router must be configured to log all packets that have been dropped.

**Rule ID:** `SV-269867r1051986_rule`
**Severity:** low
...
### Rule: The Dell OS10 Router must be configured to use encryption for routing protocol authentication.

**Rule ID:** `SV-269868r1051989_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must be configured to authenticate all routing protocol messages using NIST-validated FIPS 198-1 message authentication code algorithm.

**Rule ID:** `SV-269869r1051992_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must be configured to restrict traffic destined to itself.

**Rule ID:** `SV-269872r1052001_rule`
**Severity:** high
...
### Rule: The Dell OS10 Router must be configured to drop all fragmented Internet Control Message Protocol (ICMP) packets destined to itself.

**Rule ID:** `SV-269873r1052004_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to reject outbound route advertisements for any prefixes belonging to the IP core.

**Rule ID:** `SV-269877r1052016_rule`
**Severity:** medium
...
### Rule: The Dell OS10 out-of-band management (OOBM) gateway router must be configured to forward only authorized management traffic to the Network Operations Center (NOC).

**Rule ID:** `SV-269879r1052022_rule`
**Severity:** medium
...
### Rule: The Dell OS10 out-of-band management (OOBM) gateway router must be configured to block any traffic destined to itself that is not sourced from the OOBM network or the NOC.

**Rule ID:** `SV-269880r1052242_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must be configured to implement message authentication for all control plane protocols.

**Rule ID:** `SV-269882r1052031_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to use a unique key for each autonomous system (AS) that it peers with.

**Rule ID:** `SV-269883r1052034_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must be configured to use keys with a duration not exceeding 180 days for authenticating routing protocol messages.

**Rule ID:** `SV-269884r1052037_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must not be configured to have any zero-touch deployment feature enabled when connected to an operational network.

**Rule ID:** `SV-269885r1052040_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must be configured to protect against or limit the effects of denial-of-service (DoS) attacks by employing control plane protection.

**Rule ID:** `SV-269886r1052435_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must be configured to have Gratuitous ARP disabled on all external interfaces.

**Rule ID:** `SV-269887r1052046_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must be configured to have Internet Control Message Protocol (ICMP) unreachable notifications disabled on all external interfaces.

**Rule ID:** `SV-269889r1052052_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to use the maximum prefixes feature to protect against route table flooding and prefix deaggregation attacks.

**Rule ID:** `SV-269890r1052055_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to limit the prefix size on any inbound route advertisement to /24 or the least significant prefixes issued to the customer.

**Rule ID:** `SV-269891r1052058_rule`
**Severity:** low
...
### Rule: The Dell OS10 multicast Rendezvous Point (RP) must be configured to rate limit the number of Protocol Independent Multicast (PIM) Register messages.

**Rule ID:** `SV-269892r1052061_rule`
**Severity:** medium
...
### Rule: The Dell OS10 multicast Designated Router (DR) must be configured to filter the Internet Group Management Protocol (IGMP) and Multicast Listener Discovery (MLD) Report messages to allow hosts to join only multicast groups that have been approved by the organization.

**Rule ID:** `SV-269898r1052079_rule`
**Severity:** low
...
### Rule: The Dell OS10 multicast Designated Router (DR) must be configured to filter the Internet Group Management Protocol (IGMP) and Multicast Listener Discovery (MLD) Report messages to allow hosts to join a multicast group only from sources that have been approved by the organization.

**Rule ID:** `SV-269899r1052082_rule`
**Severity:** medium
...
### Rule: The Dell OS10 BGP router must be configured to use its loopback address as the source address for iBGP peering sessions.

**Rule ID:** `SV-269901r1052088_rule`
**Severity:** low
...
### Rule: The Dell OS10 Router must be configured to advertise a hop limit of at least 32 in Router Advertisement messages for IPv6 stateless auto-configuration deployments.

**Rule ID:** `SV-269902r1052091_rule`
**Severity:** low
...
### Rule: The Dell OS10 Router must not be configured to use IPv6 Site Local Unicast addresses.

**Rule ID:** `SV-269903r1052094_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must be configured to suppress Router Advertisements on all external IPv6-enabled interfaces.

**Rule ID:** `SV-269904r1052097_rule`
**Severity:** medium
...
### Rule: The Dell OS10 Router must not be configured to have any feature enabled that calls home to the vendor.

**Rule ID:** `SV-269927r1052166_rule`
**Severity:** medium
