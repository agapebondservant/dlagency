...
### Rule: Organization-specific Trellix Applications Control Options policies must be created and applied to all endpoints.

**Rule ID:** `SV-213335r944844_rule`
**Severity:** medium
