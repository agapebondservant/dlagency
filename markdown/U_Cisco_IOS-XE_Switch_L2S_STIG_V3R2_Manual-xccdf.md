# STIG Benchmark: Cisco IOS XE Switch L2S Security Technical Implementation Guide
...
### Rule: The Cisco switch must implement Rapid STP where VLANs span multiple switches with redundant links.
