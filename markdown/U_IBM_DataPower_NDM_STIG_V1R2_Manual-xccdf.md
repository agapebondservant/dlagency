# STIG Benchmark: IBM DataPower Network Device Management Security Technical Implementation Guide
...
### Rule: The DataPower Gateway must enforce the assigned privilege level for each administrator and authorizations for access to all commands relative to the privilege level in accordance with applicable policy for the device.

**Rule ID:** `SV-79471r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must enforce approved authorizations for controlling the flow of management information within DataPower based on information flow control policies.

**Rule ID:** `SV-79553r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must display the Standard Mandatory DoD Notice and Consent Banner before granting access to the device.

**Rule ID:** `SV-79555r1_rule`
**Severity:** low
...
### Rule: The DataPower Gateway must retain the Standard Mandatory DoD Notice and Consent Banner on the screen until the administrator acknowledges the usage conditions and takes explicit actions to log on for further access.

**Rule ID:** `SV-79557r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must provide audit record generation capability for DoD-defined auditable events within DataPower.

**Rule ID:** `SV-79559r1_rule`
**Severity:** medium
...
## Group: SRG-APP-000090-NDM-000222

**Group ID:** `V-65071`

### Rule: The DataPower Gateway must allow only the ISSM (or individuals or roles appointed by the ISSM) to select which auditable events are to be audited.

**Rule ID:** `SV-79561r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must alert the ISSO and SA (at a minimum) in the event of an audit processing failure.

**Rule ID:** `SV-79563r1_rule`
**Severity:** medium
...
## Group: SRG-APP-000118-NDM-000235

**Group ID:** `V-65075`

### Rule: The DataPower Gateway must protect audit information from any type of unauthorized read access.

**Rule ID:** `SV-79565r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must protect audit tools from unauthorized access.

**Rule ID:** `SV-79567r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must protect audit tools from unauthorized modification.

**Rule ID:** `SV-79569r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must protect audit tools from unauthorized deletion.

**Rule ID:** `SV-79571r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must back up audit records at least every seven days onto a different system or system component than the system or component being audited.

**Rule ID:** `SV-79573r1_rule`
**Severity:** low
...
### Rule: The DataPower Gateway must prevent the installation of patches, service packs, or application components without verification the software component has been digitally signed using a certificate that is recognized and approved by the organization.

**Rule ID:** `SV-79575r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must limit privileges to change the software resident within software libraries.

**Rule ID:** `SV-79577r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must enforce a minimum 15-character password length.

**Rule ID:** `SV-79581r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must prohibit password reuse for a minimum of five generations.

**Rule ID:** `SV-79583r1_rule`
**Severity:** medium
...
### Rule: If multifactor authentication is not supported and passwords must be used, the DataPower Gateway must enforce password complexity by requiring that at least one upper-case character be used.

**Rule ID:** `SV-79585r1_rule`
**Severity:** medium
...
### Rule: If multifactor authentication is not supported and passwords must be used, the DataPower Gateway must enforce password complexity by requiring that at least one lower-case character be used.

**Rule ID:** `SV-79587r1_rule`
**Severity:** medium
...
### Rule: If multifactor authentication is not supported and passwords must be used, the DataPower Gateway must enforce password complexity by requiring that at least one numeric character be used.

**Rule ID:** `SV-79589r1_rule`
**Severity:** medium
...
### Rule: If multifactor authentication is not supported and passwords must be used, the DataPower Gateway must enforce password complexity by requiring that at least one special character be used.

**Rule ID:** `SV-79591r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must map the authenticated identity to the user account for PKI-based authentication.

**Rule ID:** `SV-79593r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must use mechanisms meeting the requirements of applicable federal laws, Executive Orders, directives, policies, regulations, standards, and guidance for authentication to a cryptographic module.

**Rule ID:** `SV-79595r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must terminate all network connections associated with a device management session at the end of the session, or the session must be terminated after 10 minutes of inactivity except to fulfill documented and validated mission requirements.

**Rule ID:** `SV-79597r1_rule`
**Severity:** high
...
### Rule: The DataPower Gateway must generate unique session identifiers using a FIPS 140-2 approved random number generator.

**Rule ID:** `SV-79599r1_rule`
**Severity:** medium
...
## Group: SRG-APP-000268-NDM-000274

**Group ID:** `V-65111`

### Rule: The DataPower Gateway must activate a system alert message, send an alarm, and/or automatically shut down when a component failure is detected.

**Rule ID:** `SV-79601r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must generate alerts that can be forwarded to the administrators and ISSO when accounts are created.

**Rule ID:** `SV-79603r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must generate alerts that can be forwarded to the administrators and ISSO when accounts are modified.

**Rule ID:** `SV-79605r1_rule`
**Severity:** medium
...
## Group: SRG-APP-000293-NDM-000277

**Group ID:** `V-65117`

### Rule: The DataPower Gateway must generate alerts that can be forwarded to the administrators and ISSO when accounts are disabled.

**Rule ID:** `SV-79607r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must generate alerts that can be forwarded to the administrators and ISSO when accounts are removed.

**Rule ID:** `SV-79609r1_rule`
**Severity:** medium
...
## Group: SRG-APP-000295-NDM-000279

**Group ID:** `V-65121`

### Rule: The DataPower Gateway must automatically terminate a network administrator session after organization-defined conditions or trigger events requiring session disconnect.

**Rule ID:** `SV-79611r2_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must provide a logout capability for administrator-initiated communication sessions.
...
## Group: SRG-APP-000297-NDM-000281

**Group ID:** `V-65125`

### Rule: The DataPower Gateway must display an explicit logout message to administrators indicating the reliable termination of authenticated communications sessions.
...
### Rule: The DataPower Gateway must automatically audit account enabling actions.
...
### Rule: The DataPower Gateway must generate an immediate alert for account enabling actions.

**Rule ID:** `SV-79619r1_rule`
**Severity:** medium
...
## Group: SRG-APP-000325-NDM-000285

**Group ID:** `V-65131`

### Rule: The DataPower Gateway must be compliant with at least one IETF standard authentication protocol.

**Rule ID:** `SV-79621r1_rule`
**Severity:** medium
...
### Rule: If the DataPower Gateway uses discretionary access control, the DataPower Gateway must enforce organization-defined discretionary access control policies over defined subjects and objects.

**Rule ID:** `SV-79625r1_rule`
**Severity:** medium
...
### Rule: If the DataPower Gateway uses role-based access control, the DataPower Gateway must enforce role-based access control policies over defined subjects and objects.

**Rule ID:** `SV-79627r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must audit the execution of privileged functions.

**Rule ID:** `SV-79629r1_rule`
**Severity:** medium
...
## Group: SRG-APP-000353-NDM-000292

**Group ID:** `V-65141`

### Rule: The DataPower Gateway must provide the capability for organization-identified individuals or roles to change the auditing to be performed based on all selectable event criteria within near-real-time.

**Rule ID:** `SV-79631r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must allocate audit record storage capacity in accordance with organization-defined audit record storage requirements.

**Rule ID:** `SV-79633r1_rule`
**Severity:** medium
...
## Group: SRG-APP-000359-NDM-000294

**Group ID:** `V-65145`

### Rule: The DataPower Gateway must generate an immediate alert when allocated audit record storage volume reaches 75% of repository maximum audit record storage capacity.

**Rule ID:** `SV-79635r1_rule`
**Severity:** low
...
### Rule: The DataPower Gateway must generate an immediate real-time alert of all audit failure events.

**Rule ID:** `SV-79637r1_rule`
**Severity:** low
...
### Rule: The DataPower Gateway must compare internal information system clocks at least every 24 hours with an authoritative time server.

**Rule ID:** `SV-79639r1_rule`
**Severity:** low
...
### Rule: The DataPower Gateway must synchronize internal information system clocks to the authoritative time source when the time difference is greater than one second.

**Rule ID:** `SV-79641r1_rule`
**Severity:** low
...
### Rule: The DataPower Gateway must be configured to synchronize internal information system clocks with the primary and secondary time sources located in different geographic regions using redundant authoritative time sources.

**Rule ID:** `SV-79643r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must record time stamps for audit records that can be mapped to Coordinated Universal Time (UTC) or Greenwich Mean Time (GMT).
...
## Group: SRG-APP-000379-NDM-000303

**Group ID:** `V-65157`

### Rule: The DataPower Gateway must implement organization-defined automated security responses if baseline configurations are changed in an unauthorized manner.

**Rule ID:** `SV-79647r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must enforce access restrictions associated with changes to device configuration.

**Rule ID:** `SV-79649r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must audit the enforcement actions used to restrict access associated with changes to the device.

**Rule ID:** `SV-79651r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must use SNMPv3.

**Rule ID:** `SV-79655r1_rule`
**Severity:** high
...
### Rule: The IBM DataPower Gateway must only allow the use of protocols that implement cryptographic mechanisms to protect the integrity and confidentiality of management communications.

**Rule ID:** `SV-79659r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must off-load audit records onto a different system or media than the system being audited.
...
## Group: SRG-APP-000516-NDM-000333

**Group ID:** `V-65173`

### Rule: The DataPower Gateway must use automated mechanisms to alert security personnel to threats identified by authoritative sources (e.g., CTOs) and in accordance with CJCSM 6510.01B.
...
### Rule: The DataPower Gateway must generate audit log events for a locally developed list of auditable events.

**Rule ID:** `SV-79665r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must employ automated mechanisms to centrally manage authentication settings.

**Rule ID:** `SV-79667r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must employ automated mechanisms to centrally apply authentication settings.

**Rule ID:** `SV-79669r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must employ automated mechanisms to centrally verify authentication settings.
...
### Rule: The DataPower Gateway must support organizational requirements to conduct backups of system level information contained in the information system when changes occur or weekly, whichever is sooner.

**Rule ID:** `SV-79673r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must employ automated mechanisms to assist in the tracking of security incidents.

**Rule ID:** `SV-79675r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must obtain its public key certificates from an appropriate certificate policy through an approved service provider.

**Rule ID:** `SV-79677r1_rule`
**Severity:** medium
...
### Rule: The DataPower Gateway must not use 0.0.0.0 as the management IP address.
