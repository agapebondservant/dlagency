...
**Rule ID:** `SV-259169r1067578_rule`
**Severity:** medium
...
**Check Text:**
At the command prompt, run the following commands: # /opt/vmware/vpostgres/current/bin/psql -U postgres -A -t -c "SHOW pgaudit.log;" If the "pgaudit.log" setting is not configured to "all, -misc, -read", this is a finding.
...
**Rule ID:** `SV-259174r1043177_rule`
**Severity:** medium
...
**Rule ID:** `SV-259175r1051115_rule`
**Severity:** medium
...
**Rule ID:** `SV-259176r1015952_rule`
**Severity:** high
...
**Rule ID:** `SV-259181r1015953_rule`
**Severity:** medium
