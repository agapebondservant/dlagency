...
### Rule: ACF2 PSWD GSO record value must be set to require at least one upper-case character be used.
...
### Rule: ACF2 PSWD GSO record value must be set to require at least one lower-case character be used.
...
### Rule: ACF2 PSWD GSO record value must be set to require the change of at least 50% of the total number of characters when passwords are changed.
...
### Rule: ACF2 PSWD GSO record value must be set to require 24 hours/1 day as the minimum password lifetime.
...
### Rule: IBM z/OS system administrator must develop a process notify appropriate personnel when accounts are removed.
...
### Rule: IBM z/OS system administrator must develop a process notify appropriate personnel when accounts are modified.
...
### Rule: IBM z/OS system administrator must develop a process notify appropriate personnel when accounts are deleted.
...
### Rule: IBM z/OS system administrator must develop a process notify appropriate personnel when accounts are created.
...
### Rule: IBM z/OS System Administrator must develop a procedure to automatically remove or disable temporary user accounts after 72 hours.
...
### Rule: IBM z/OS system administrator must develop a procedure to notify system administrators and ISSOs of account enabling actions.
...
### Rule: IBM z/OS system administrator must develop a procedure to terminate all sessions and network connections related to nonlocal maintenance when nonlocal maintenance is completed.
...
### Rule: IBM z/OS PROFILE.TCPIP configuration for the TN3270 Telnet Server must have INACTIVE statement properly specified.
...
### Rule: IBM z/OS UNIX HFS permission bits and audit bits for each directory must be properly protected or specified.
...
### Rule: The operating system must enforce a minimum 8-character password length.
