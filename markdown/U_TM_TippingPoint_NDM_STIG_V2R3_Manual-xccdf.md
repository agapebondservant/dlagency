...
**Rule ID:** `SV-242236r1082950_rule`
**Severity:** high
...
**Check Text:**
1. For SMS, click "Admin and Management". 2. Ensure only Ping is enabled and the SMS is in FIPS Mode. 3. For TPS, click Devices >> All Devices, and the subject device hostname. 4. Click "Device Configuration" and select "Services". Ensure only TLS 1.2 is enabled. 5. Verify only SSH and Ping are enabled and the SMS is in FIPS Mode. If any other services are enabled, this is a finding.
...
**Rule ID:** `SV-242237r1051115_rule`
**Severity:** medium
...
**Rule ID:** `SV-242238r1018786_rule`
**Severity:** medium
...
**Rule ID:** `SV-242239r1018787_rule`
**Severity:** medium
...
**Rule ID:** `SV-242240r1018788_rule`
**Severity:** medium
...
**Rule ID:** `SV-242241r1018789_rule`
**Severity:** medium
...
**Rule ID:** `SV-242242r1018790_rule`
**Severity:** medium
...
**Rule ID:** `SV-242244r1018626_rule`
**Severity:** high
...
**Check Text:**
In the SMS client, ensure the SMS inactivity timeouts are configured. 1. Under Security, click Edit and Preferences. 2. Under Client Preferences, if "Timeout client session after inactivity" is not checked or the Time is not set to five minutes, this is a finding.
...
**Rule ID:** `SV-242246r1018791_rule`
**Severity:** medium
...
### Rule: The TippingPoint SMS must be configured to send log data to at least two central log servers for the purpose of forwarding alerts to the administrators and the information system security officer (ISSO).

**Rule ID:** `SV-242259r1028385_rule`
**Severity:** high
...
**Check Text:**
1. Navigate to Admin >> Server properties >> Syslog. 2. Verify the configuration enables TCP or Encrypted TCP. 3. Verify Device Audit, Device System, SMS Audit, and SMS System log types are enabled and configured. If syslog is not configured to use TCP or Encrypted TCP or does not include the four log types, this is a finding.
