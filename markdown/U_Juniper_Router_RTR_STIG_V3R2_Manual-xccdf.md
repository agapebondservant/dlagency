# STIG Benchmark: Juniper Router RTR Security Technical Implementation Guide
...
### Rule: The Juniper router must be configured to enforce approved authorizations for controlling the flow of information within the network based on organization-defined information flow control policies.

**Rule ID:** `SV-217011r604135_rule`
**Severity:** medium
...
### Rule: The Juniper router must be configured to implement message authentication for all control plane protocols.

**Rule ID:** `SV-217012r945861_rule`
**Severity:** medium
...
### Rule: The Juniper router must be configured to use keys with a duration not exceeding 180 days for authenticating routing protocol messages.

**Rule ID:** `SV-217013r945863_rule`
**Severity:** medium
...
### Rule: The Juniper router must be configured to use encryption for routing protocol authentication.
...
### Rule: The Juniper router must be configured to authenticate all routing protocol messages using NIST-validated FIPS 140-2 message authentication code algorithm.
...
### Rule: The Juniper router must be configured to have all inactive interfaces disabled.
...
### Rule: The Juniper router must be configured to have all non-essential capabilities disabled.

**Rule ID:** `SV-217017r604135_rule`
**Severity:** low
...
### Rule: The Juniper router must be configured to protect against or limit the effects of denial-of-service (DoS) attacks by employing control plane protection.

**Rule ID:** `SV-217018r991997_rule`
**Severity:** medium
...
### Rule: The Juniper router must be configured to restrict traffic destined to itself.
...
### Rule: The Juniper router must be configured to drop all fragmented Internet Control Message Protocol (ICMP) packets destined to itself.
...
### Rule: The Juniper router must be configured to have Gratuitous ARP disabled on all external interfaces.

**Rule ID:** `SV-217021r855889_rule`
**Severity:** medium
...
### Rule: The Juniper router must be configured to have Internet Control Message Protocol (ICMP) unreachable messages disabled on all external interfaces.

**Rule ID:** `SV-217022r855890_rule`
**Severity:** medium
...
### Rule: The Juniper router must be configured to have Internet Control Message Protocol (ICMP) mask reply messages disabled on all external interfaces.
...
### Rule: The Juniper router must be configured to have Internet Control Message Protocol (ICMP) redirect messages disabled on all external interfaces.

**Rule ID:** `SV-217024r855892_rule`
**Severity:** medium
...
### Rule: The Juniper router must be configured to log all packets that have been dropped.

**Rule ID:** `SV-217025r604135_rule`
**Severity:** low
...
### Rule: The Juniper router must be configured to produce audit records containing information to establish where the events occurred.

**Rule ID:** `SV-217026r604135_rule`
**Severity:** medium
...
### Rule: The Juniper router must be configured to produce audit records containing information to establish the source of the events.

**Rule ID:** `SV-217027r604135_rule`
**Severity:** medium
...
### Rule: The Juniper router must be configured to disable the auxiliary port unless it is connected to a secured modem providing encryption and authentication.
...
### Rule: The Juniper perimeter router must be configured to deny network traffic by default and allow network traffic by exception.

**Rule ID:** `SV-217029r604135_rule`
**Severity:** high
...
### Rule: The Juniper perimeter router must be configured to enforce approved authorizations for controlling the flow of information between interconnected networks in accordance with applicable policy.
...
### Rule: The Juniper perimeter router must be configured to only allow incoming communications from authorized sources to be routed to authorized destinations.

**Rule ID:** `SV-217031r855893_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to block inbound packets with source Bogon IP address prefixes.

**Rule ID:** `SV-217032r855894_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to not redistribute static routes to an alternate gateway service provider into BGP or an IGP peering with the NIPRNet or to other autonomous systems.

**Rule ID:** `SV-217035r604135_rule`
**Severity:** low
...
### Rule: The Juniper perimeter router must be configured to restrict it from accepting outbound IP packets that contain an illegitimate address in the source address field via egress filter or by enabling Unicast Reverse Path Forwarding (uRPF).

**Rule ID:** `SV-217036r945858_rule`
**Severity:** high
...
### Rule: The Juniper perimeter router must be configured to filter traffic destined to the enclave in accordance with the guidelines contained in DoD Instruction 8551.1.

**Rule ID:** `SV-217037r604135_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to filter ingress traffic at the external interface on an inbound direction.

**Rule ID:** `SV-217038r604135_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to filter egress traffic at the internal interface on an inbound direction.

**Rule ID:** `SV-217039r604135_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to block all packets with any IP options.

**Rule ID:** `SV-217040r945859_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to have Link Layer Discovery Protocol (LLDP) disabled on all external interfaces.

**Rule ID:** `SV-217041r855896_rule`
**Severity:** low
...
### Rule: The Juniper perimeter router must be configured to have Proxy ARP disabled on all external interfaces.

**Rule ID:** `SV-217042r855897_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to block all outbound management traffic.

**Rule ID:** `SV-217043r1050852_rule`
**Severity:** medium
...
**Check Text:**
This requirement is not applicable for the DODIN backbone. The perimeter router of the managed network must be configured with an outbound filter on the egress interface to block all management traffic as shown in the example below. Verify that the router has been configured with an outbound filter as shown in the example below. interfaces { description "NIPRNet"; ge-0/0/0 { unit 0 { family inet { no-redirects; filter { output OUTBOUND_FILTER; } address 10.1.12.2/24; } } } Verify that the outbound filter discards or rejects management traffic as shown in the example below. firewall { family inet { … … … } filter OUTBOUND_FILTER { term BLOCK_TACACS { from { protocol tcp; port tacacs; } then { syslog; discard; } } term BLOCK_SNMP { from { protocol udp; port [ snmp snmptrap ]; } then { syslog; discard; } } term BLOCK_NETFLOW { from { protocol udp; port [ 2055 9995 9996 ]; } then { syslog; discard; } } term ALLOW_OTHER { then accept; } } } If management traffic is not blocked at the perimeter, this is a finding.

## Group: SRG-NET-000205-RTR-000009

**Group ID:** `V-217044`

### Rule: The Juniper out-of-band management (OOBM) gateway router must be configured to transport management traffic to the Network Operations Center (NOC) via dedicated circuit, MPLS/VPN service, or IPsec tunnel.

**Rule ID:** `SV-217044r1050855_rule`
**Severity:** medium
...
### Rule: The Juniper out-of-band management (OOBM) gateway router must be configured to forward only authorized management traffic to the Network Operations Center (NOC).

**Rule ID:** `SV-217045r604135_rule`
**Severity:** medium
...
### Rule: The Juniper out-of-band management (OOBM) gateway router must be configured to have separate IGP instances for the managed network and management network.
...
### Rule: The Juniper out-of-band management (OOBM) gateway router must be configured to not redistribute routes between the management network routing domain and the managed network routing domain.
...
### Rule: The Juniper out-of-band management (OOBM) gateway router must be configured to block any traffic destined to itself that is not sourced from the OOBM network or the NOC.
...
### Rule: The Juniper router must be configured to only permit management traffic that ingresses and egresses the OOBM interface.

**Rule ID:** `SV-217049r604135_rule`
**Severity:** medium
...
## Group: SRG-NET-000205-RTR-000013

**Group ID:** `V-217050`

### Rule: The Juniper router providing connectivity to the NOC must be configured to forward all in-band management traffic via an IPsec tunnel.

**Rule ID:** `SV-217050r604135_rule`
**Severity:** medium
...
### Rule: The Juniper BGP router must be configured to enable the Generalized TTL Security Mechanism (GTSM).

**Rule ID:** `SV-217051r855898_rule`
**Severity:** low
...
### Rule: The Juniper BGP router must be configured to use a unique key for each autonomous system (AS) that it peers with.

**Rule ID:** `SV-217052r945862_rule`
**Severity:** medium
...
### Rule: The Juniper BGP router must be configured to reject inbound route advertisements for any Bogon prefixes.

**Rule ID:** `SV-217053r604135_rule`
**Severity:** medium
...
### Rule: The Juniper BGP router must be configured to reject inbound route advertisements for any prefixes belonging to the local autonomous system (AS).
...
### Rule: The Juniper BGP router must be configured to reject inbound route advertisements from a customer edge (CE) Juniper router for prefixes that are not allocated to that customer.

**Rule ID:** `SV-217055r604135_rule`
**Severity:** medium
...
### Rule: The Juniper BGP router must be configured to reject outbound route advertisements for any prefixes that do not belong to any customers or the local autonomous system (AS).

**Rule ID:** `SV-217056r604135_rule`
**Severity:** medium
...
### Rule: The Juniper BGP router must be configured to reject outbound route advertisements for any prefixes belonging to the IP core.
...
### Rule: The Juniper BGP router must be configured to reject route advertisements from BGP peers that do not list their autonomous system (AS) number as the first AS in the AS_PATH attribute.

**Rule ID:** `SV-217058r945854_rule`
**Severity:** low
...
### Rule: The Juniper BGP router must be configured to reject route advertisements from CE routers with an originating AS in the AS_PATH attribute that does not belong to that customer.

**Rule ID:** `SV-217059r945855_rule`
**Severity:** low
...
### Rule: The Juniper BGP router must be configured to use the maximum prefixes feature to protect against route table flooding and prefix de-aggregation attacks.

**Rule ID:** `SV-217060r855900_rule`
**Severity:** medium
...
### Rule: The Juniper BGP router must be configured to limit the prefix size on any inbound route advertisement to /24 or the least significant prefixes issued to the customer.

**Rule ID:** `SV-217061r855901_rule`
**Severity:** low
...
### Rule: The Juniper BGP router must be configured to use its loopback address as the source address for iBGP peering sessions.

**Rule ID:** `SV-217062r992001_rule`
**Severity:** low
...
### Rule: The Juniper MPLS router must be configured to use its loopback address as the source address for LDP peering sessions.

**Rule ID:** `SV-217063r992002_rule`
**Severity:** low
...
### Rule: The Juniper MPLS router must be configured to synchronize IGP and LDP to minimize packet loss when an IGP adjacency is established prior to LDP peers completing label exchange.

**Rule ID:** `SV-217064r604135_rule`
**Severity:** low
...
### Rule: The Juniper MPLS router with RSVP-TE enabled must be configured to enable refresh reduction features.

**Rule ID:** `SV-217065r604135_rule`
**Severity:** low
...
### Rule: The Juniper MPLS router must be configured to have TTL Propagation disabled.
...
### Rule: The Juniper PE router must be configured to have each Virtual Routing and Forwarding (VRF) instance bound to the appropriate physical or logical interfaces to maintain traffic separation between all MPLS L3VPNs.

**Rule ID:** `SV-217067r992003_rule`
**Severity:** high
...
### Rule: The Juniper PE router must be configured to have each Virtual Routing and Forwarding (VRF) instance with the appropriate Route Target (RT).

**Rule ID:** `SV-217068r992004_rule`
**Severity:** high
...
### Rule: The Juniper PE router must be configured to have each VRF with the appropriate Route Distinguisher (RD).

**Rule ID:** `SV-217069r992005_rule`
**Severity:** medium
...
### Rule: The Juniper PE router providing MPLS Layer 2 Virtual Private Network (L2VPN) services must be configured to authenticate targeted Label Distribution Protocol (LDP) sessions used to exchange virtual circuit (VC) information using a FIPS-approved message authentication code algorithm.

**Rule ID:** `SV-217070r878055_rule`
**Severity:** medium
...
### Rule: The Juniper PE router providing MPLS Virtual Private Wire Service (VPWS) must be configured to have the appropriate virtual circuit identification (VC ID) for each attachment circuit.

**Rule ID:** `SV-217071r992006_rule`
**Severity:** high
...
### Rule: The Juniper PE router providing Virtual Private LAN Services (VPLS) must be configured to have all attachment circuits defined to the routing instance with the globally unique VPLS ID assigned for each customer VLAN.

**Rule ID:** `SV-217072r992007_rule`
**Severity:** high
...
### Rule: The Juniper PE router providing Virtual Private LAN Services (VPLS) must be configured to have traffic storm control thresholds on CE-facing interfaces.

**Rule ID:** `SV-217073r604135_rule`
**Severity:** medium
...
### Rule: The Juniper PE router must be configured to implement Protocol Independent Multicast (PIM) snooping  for each Virtual Private LAN Services (VPLS) bridge domain.
...
### Rule: The Juniper PE router must be configured to limit the number of MAC addresses it can learn for each Virtual Private LAN Services (VPLS) bridge domain.

**Rule ID:** `SV-217075r604135_rule`
**Severity:** medium
...
### Rule: The Juniper PE router must be configured to block any traffic that is destined to IP core infrastructure.

**Rule ID:** `SV-217076r604135_rule`
**Severity:** high
...
### Rule: The Juniper PE router must be configured with Unicast Reverse Path Forwarding (uRPF) loose mode enabled on all CE-facing interfaces.
...
### Rule: The Juniper PE router must be configured to ignore or block all packets with any IP options.

**Rule ID:** `SV-217078r945860_rule`
**Severity:** medium
...
### Rule: The Juniper PE router must be configured to enforce a Quality-of-Service (QoS) policy in accordance with the QoS GIG Technical Profile.

**Rule ID:** `SV-217079r604135_rule`
**Severity:** low
...
### Rule: The Juniper P router must be configured to enforce a Quality-of-Service (QoS) policy in accordance with the QoS GIG Technical Profile.

**Rule ID:** `SV-217080r604135_rule`
**Severity:** low
...
### Rule: The Juniper PE router must be configured to enforce a Quality-of-Service (QoS) policy to limit the effects of packet flooding denial-of-service (DoS) attacks.

**Rule ID:** `SV-217081r604135_rule`
**Severity:** medium
...
### Rule: The Juniper multicast router must be configured to disable Protocol Independent Multicast (PIM) on all interfaces that are not required to support multicast routing.
...
### Rule: The Juniper multicast router must be configured to bind a Protocol Independent Multicast (PIM) neighbor filter to interfaces that have PIM enabled.
...
### Rule: The Juniper multicast edge router must be configured to establish boundaries for administratively scoped multicast traffic.

**Rule ID:** `SV-217084r604135_rule`
**Severity:** low
...
### Rule: The Juniper multicast Rendezvous Point (RP) router must be configured to limit the multicast forwarding cache so that its resources are not saturated by managing an overwhelming number of Protocol Independent Multicast (PIM) and Multicast Source Discovery Protocol (MSDP) source-active entries.

**Rule ID:** `SV-217085r878057_rule`
**Severity:** low
...
### Rule: The Juniper multicast Rendezvous Point (RP) router must be configured to filter Protocol Independent Multicast (PIM) Register messages received from the Designated Router (DR) for any undesirable multicast groups and sources.

**Rule ID:** `SV-217086r604135_rule`
**Severity:** low
...
### Rule: The Juniper multicast Rendezvous Point (RP) router must be configured to filter Protocol Independent Multicast (PIM) Join messages received from the Designated Juniper router (DR) for any undesirable multicast groups.

**Rule ID:** `SV-217087r604135_rule`
**Severity:** low
...
### Rule: The Juniper multicast Rendezvous Point (RP) must be configured to rate limit the number of Protocol Independent Multicast (PIM) Register messages.

**Rule ID:** `SV-217088r855906_rule`
**Severity:** medium
...
### Rule: The Juniper multicast Designated Router (DR) must be configured to filter the Internet Group Management Protocol (IGMP) and Multicast Listener Discovery (MLD) Report messages to allow hosts to join only multicast groups that have been approved by the organization.

**Rule ID:** `SV-217089r878058_rule`
**Severity:** low
...
### Rule: The Juniper multicast Designated Router (DR) must be configured to filter the Internet Group Management Protocol (IGMP) and Multicast Listener Discovery (MLD) Report messages to allow hosts to join a multicast group only from sources that have been approved by the organization.

**Rule ID:** `SV-217090r878059_rule`
**Severity:** medium
...
### Rule: The Juniper multicast Designated Router (DR) must be configured to limit the number of mroute states resulting from Internet Group Management Protocol (IGMP) and Multicast Listener Discovery (MLD) Host Membership Reports.

**Rule ID:** `SV-217091r855909_rule`
**Severity:** medium
...
### Rule: The Juniper multicast Designated Router (DR) must be configured to set the shortest-path tree (SPT) threshold to infinity to minimalize source-group (S, G) state within the multicast topology where Any Source Multicast (ASM) is deployed.

**Rule ID:** `SV-217092r945856_rule`
**Severity:** medium
...
### Rule: The Juniper Multicast Source Discovery Protocol (MSDP) router must be configured to only accept MSDP packets from known MSDP peers.
...
### Rule: The Juniper Multicast Source Discovery Protocol (MSDP) router must be configured to authenticate all received MSDP packets.
...
### Rule: The Juniper Multicast Source Discovery Protocol (MSDP) router must be configured to filter received source-active multicast advertisements for any undesirable multicast groups and sources.

**Rule ID:** `SV-217095r835204_rule`
**Severity:** low
...
### Rule: The Juniper Multicast Source Discovery Protocol (MSDP) router must be configured to filter source-active multicast advertisements to external MSDP peers to avoid global visibility of local-only multicast sources and groups.

**Rule ID:** `SV-217096r819169_rule`
**Severity:** low
...
### Rule: The Juniper Multicast Source Discovery Protocol (MSDP) router must be configured to limit the amount of source-active messages it accepts on per-peer basis.
...
### Rule: The Juniper Multicast Source Discovery Protocol (MSDP) router must be configured to use its loopback address as the source address when originating MSDP traffic.

**Rule ID:** `SV-217098r992008_rule`
**Severity:** low
...
### Rule: The Juniper perimeter router must be configured to suppress Router Advertisements on all external IPv6-enabled interfaces.
...
### Rule: The Juniper router must not be configured to use IPv6 Site Local Unicast addresses.

**Rule ID:** `SV-233293r604135_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured drop IPv6 packets with a Routing Header type 0, 1, or 3255.

**Rule ID:** `SV-233294r878056_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to drop IPv6 packets containing a Hop-by-Hop header with invalid option type values.

**Rule ID:** `SV-233295r855914_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to drop IPv6 packets containing a Destination Option header with invalid option type values.

**Rule ID:** `SV-233296r855915_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to drop IPv6 packets containing an extension header with the Endpoint Identification option.

**Rule ID:** `SV-233297r855916_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to drop IPv6 packets containing the NSAP address option within Destination Option header.

**Rule ID:** `SV-233298r855917_rule`
**Severity:** medium
...
### Rule: The Juniper perimeter router must be configured to drop IPv6 packets containing a Hop-by-Hop or Destination Option extension header with an undefined option type.

**Rule ID:** `SV-233299r855918_rule`
**Severity:** medium
