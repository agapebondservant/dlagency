...
**Rule ID:** `SV-234810r1009609_rule`
**Severity:** medium
...
**Rule ID:** `SV-234813r1009561_rule`
**Severity:** medium
...
**Rule ID:** `SV-234817r1009611_rule`
**Severity:** medium
...
**Rule ID:** `SV-234831r1009558_rule`
**Severity:** high
...
**Rule ID:** `SV-234834r1106567_rule`
**Severity:** medium
...
**Rule ID:** `SV-234836r1106561_rule`
**Severity:** medium
...
**Rule ID:** `SV-234838r1106563_rule`
**Severity:** medium
...
**Rule ID:** `SV-234849r1038944_rule`
**Severity:** medium
...
**Rule ID:** `SV-234852r1009613_rule`
**Severity:** high
...
**Rule ID:** `SV-234853r1050789_rule`
**Severity:** high
...
**Rule ID:** `SV-234854r1009615_rule`
**Severity:** medium
...
**Rule ID:** `SV-234855r1009616_rule`
**Severity:** medium
...
**Rule ID:** `SV-234865r1082187_rule`
**Severity:** medium
...
**Rule ID:** `SV-234869r1009617_rule`
**Severity:** medium
...
**Rule ID:** `SV-234870r1009618_rule`
**Severity:** medium
...
**Rule ID:** `SV-234871r1009619_rule`
**Severity:** medium
...
### Rule: The SUSE operating system must require reauthentication when using the "sudo" command.

**Rule ID:** `SV-234878r1050789_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Without reauthentication, users may access resources or perform tasks for which they do not have authorization. When operating systems provide the capability to escalate a functional capability, it is critical the organization requires the user to re-authenticate when using the "sudo" command. If the value is set to an integer less than 0, the user's time stamp will not expire and the user will not have to reauthenticate for privileged actions until the user's session is terminated.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
**Rule ID:** `SV-234882r1009621_rule`
**Severity:** medium
...
**Rule ID:** `SV-234883r1009622_rule`
**Severity:** medium
...
**Rule ID:** `SV-234884r1009623_rule`
**Severity:** medium
...
**Rule ID:** `SV-234885r1009624_rule`
**Severity:** medium
...
**Rule ID:** `SV-234886r1009625_rule`
**Severity:** medium
...
**Rule ID:** `SV-234887r1009626_rule`
**Severity:** medium
...
**Rule ID:** `SV-234888r1044810_rule`
**Severity:** medium
...
**Rule ID:** `SV-234889r1009628_rule`
**Severity:** medium
...
**Rule ID:** `SV-234890r1009629_rule`
**Severity:** medium
...
**Rule ID:** `SV-234891r1038967_rule`
**Severity:** medium
...
**Rule ID:** `SV-234892r1038967_rule`
**Severity:** medium
...
**Rule ID:** `SV-234895r1009632_rule`
**Severity:** medium
...
**Rule ID:** `SV-234896r1009633_rule`
**Severity:** medium
...
**Rule ID:** `SV-234899r1009634_rule`
**Severity:** medium
...
**Rule ID:** `SV-234900r1009635_rule`
**Severity:** medium
...
**Rule ID:** `SV-234901r1009636_rule`
**Severity:** medium
...
**Rule ID:** `SV-234902r1009637_rule`
**Severity:** medium
...
**Rule ID:** `SV-234958r1038966_rule`
**Severity:** medium
...
**Rule ID:** `SV-234963r1009638_rule`
**Severity:** low
...
**Rule ID:** `SV-234964r1009639_rule`
**Severity:** medium
...
**Rule ID:** `SV-234978r1009573_rule`
**Severity:** medium
...
**Rule ID:** `SV-251724r1050789_rule`
**Severity:** medium
...
### Rule: The SUSE operating system must audit any script or executable called by cron as root or by any privileged user.

**Rule ID:** `SV-274879r1106564_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Any script or executable called by cron as root or by any privileged user must be owned by that user, must have the permissions 755 or more restrictive, and have no extended rights that allow any nonprivileged user to modify the script or executable.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>

**Check Text:**
Verify the SUSE operating system is configured to audit the execution of any system call made by cron as root or as any privileged user. > sudo auditctl -l | grep /etc/cron.d -w /etc/cron.d -p wa -k cronjobs $ sudo auditctl -l | grep /var/spool/cron -w /var/spool/cron -p wa -k cronjobs If either of these commands do not return the expected output, or the lines are commented out, this is a finding.
