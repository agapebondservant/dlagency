# STIG Benchmark: Apple iOS/iPadOS 15 Security Technical Implementation Guide
...
### Rule: Apple iOS/iPadOS 15 must provide the capability for the Administrator (MDM) to perform the following management function: enable/disable VPN protection across the device and [selection: other methods].

**Rule ID:** `SV-250919r801848_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must not allow backup to remote systems (iCloud).

**Rule ID:** `SV-250920r801851_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not allow backup to remote systems (iCloud document and data synchronization).

**Rule ID:** `SV-250921r801854_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not allow backup to remote systems (iCloud Keychain).

**Rule ID:** `SV-250922r801857_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not allow backup to remote systems (My Photo Stream).

**Rule ID:** `SV-250923r801860_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not allow backup to remote systems (iCloud Photo Sharing, also known as Shared Photo Streams).

**Rule ID:** `SV-250924r801863_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not allow backup to remote systems (managed applications data stored in iCloud).

**Rule ID:** `SV-250925r801866_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not allow backup to remote systems (enterprise books).

**Rule ID:** `SV-250926r801869_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must [selection: wipe protected data, wipe sensitive data] upon unenrollment from MDM.

**Rule ID:** `SV-250927r801872_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must [selection: remove Enterprise application, remove all noncore applications (any nonfactory-installed application)] upon unenrollment from MDM.

**Rule ID:** `SV-250928r801875_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to enforce a minimum password length of six characters.

**Rule ID:** `SV-250929r801878_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to not allow passwords that include more than two repeating or sequential characters.

**Rule ID:** `SV-250930r801881_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to enable a screen-lock policy that will lock the display after a period of inactivity.

**Rule ID:** `SV-250931r801884_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to lock the display after 15 minutes (or less) of inactivity.

**Rule ID:** `SV-250932r801887_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to not allow more than 10 consecutive failed authentication attempts.

**Rule ID:** `SV-250933r801890_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to enforce an application installation policy by specifying one or more authorized application repositories, including [selection: DoD-approved commercial app repository, MDM server, mobile application store].

**Rule ID:** `SV-250934r801893_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not include applications with the following characteristics: access to Siri when the device is locked.

**Rule ID:** `SV-250935r801896_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 allow list must be configured to not include applications with the following characteristics: voice dialing application if available when MD is locked.

**Rule ID:** `SV-250936r801899_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to not display notifications when the device is locked.

**Rule ID:** `SV-250938r801905_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not display notifications (calendar information) when the device is locked.

**Rule ID:** `SV-250939r801908_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to display the DoD advisory warning message at startup or each time the user unlocks the device.

**Rule ID:** `SV-250940r801911_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must be configured to not allow backup of [all applications, configuration data] to locally connected systems.

**Rule ID:** `SV-250941r801914_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not allow non-DoD applications to access DoD data.

**Rule ID:** `SV-250942r853255_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to disable multiuser modes.
...
### Rule: Apple iOS/iPadOS 15 must be configured to [selection: wipe protected data, wipe sensitive data] upon unenrollment from MDM.

**Rule ID:** `SV-250944r801923_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to [selection: remove Enterprise applications, remove all noncore applications (any nonfactory installed application)] upon unenrollment from MDM.

**Rule ID:** `SV-250945r801926_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must be configured to disable ad hoc wireless client-to-client connection capability.

**Rule ID:** `SV-250946r853257_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must require a valid password be successfully entered before the mobile device data is unencrypted.

**Rule ID:** `SV-250947r801932_rule`
**Severity:** high
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: limit Ad Tracking.

**Rule ID:** `SV-250948r836937_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: not allow automatic completion of Safari browser passcodes.

**Rule ID:** `SV-250949r801938_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: Encrypt iTunes backups/Encrypt local backup.

**Rule ID:** `SV-250950r801941_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: not allow use of Handoff.

**Rule ID:** `SV-250951r801944_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: require the user to enter a password when connecting to an AirPlay-enabled device for the first time.

**Rule ID:** `SV-250952r801947_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: Disable Allow MailDrop.

**Rule ID:** `SV-250953r801950_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: Disable Allow Shared Albums.

**Rule ID:** `SV-250954r801953_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: use SSL for Exchange ActiveSync.

**Rule ID:** `SV-250956r801959_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: not allow messages in an ActiveSync Exchange account to be forwarded or moved to other accounts in the Apple iOS/iPadOS 15 Mail app.

**Rule ID:** `SV-250957r801962_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: Treat AirDrop as an unmanaged destination.

**Rule ID:** `SV-250958r801965_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: not have any Family Members in Family Sharing.

**Rule ID:** `SV-250959r801968_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: not share location data through iCloud.

**Rule ID:** `SV-250960r801971_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: force Apple Watch wrist detection.

**Rule ID:** `SV-250961r801974_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 users must complete required training.

**Rule ID:** `SV-250962r801977_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: enable USB Restricted Mode.

**Rule ID:** `SV-250964r836935_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must not allow managed apps to write contacts to unmanaged contacts accounts.

**Rule ID:** `SV-250965r801986_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must not allow unmanaged apps to read contacts from managed contacts accounts.

**Rule ID:** `SV-250966r801989_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: disable AirDrop.

**Rule ID:** `SV-250967r801992_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 15 must implement the management setting: disable paired Apple Watch.

**Rule ID:** `SV-250968r801995_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable Password AutoFill in browsers and applications.

**Rule ID:** `SV-250969r858425_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable allow setting up new nearby devices.

**Rule ID:** `SV-250970r802001_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable password proximity requests.

**Rule ID:** `SV-250971r802004_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable password sharing.

**Rule ID:** `SV-250972r808541_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable Find My Friends in the Find My app.

**Rule ID:** `SV-250973r802010_rule`
**Severity:** low

**Description:**
<VulnDiscussion>This control does not share a DoD user's location but encourages location sharing between DoD mobile device users, which can lead to operational security (OPSEC) risks. Sharing the location of a DoD mobile device is a violation of AIOS-15-011700. SFR ID: FMT_SMF_EXT.1.1 #47</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: The Apple iOS/iPadOS 15 must be supervised by the MDM.

**Rule ID:** `SV-250974r802013_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable "Allow USB drive access in Files app" if the Authorizing Official (AO) has not approved the use of DoD-approved USB storage drives with iOS/iPadOS devices.

**Rule ID:** `SV-250975r802016_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable "Allow network drive access in Files access".

**Rule ID:** `SV-250978r802025_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable connections to Siri servers for the purpose of dictation.

**Rule ID:** `SV-250979r802028_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable connections to Siri servers for the purpose of translation.

**Rule ID:** `SV-250980r802031_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 15 must disable copy/paste of data from managed to unmanaged applications.

**Rule ID:** `SV-250981r802034_rule`
**Severity:** medium
...
### Rule: All Apple iOS/iPadOS 15 installations must be removed.

**Rule ID:** `SV-259889r950442_rule`
**Severity:** high

**Description:**
<VulnDiscussion>Apple iOS/iPadOS 15 is no longer supported by Apple and therefore may contain security vulnerabilities. SFR ID: FMT_MOF_EXT.1.2 #47</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>

**Check Text:**
Verify there are no installations of Apple iOS/iPadOS 15 at the site. If Apple iOS/iPadOS 15 is being used at the site, this is a finding.
