...
**Rule ID:** `SV-219833r1018565_rule`
**Severity:** medium
...
**Rule ID:** `SV-219847r1067809_rule`
**Severity:** medium
...
**Rule ID:** `SV-219868r1018568_rule`
**Severity:** medium
...
**Rule ID:** `SV-220265r1043176_rule`
**Severity:** high
...
**Rule ID:** `SV-220289r1043177_rule`
**Severity:** medium
...
**Rule ID:** `SV-220290r1015773_rule`
**Severity:** high
...
### Rule: Oracle Database must map the PKI-authenticated identity to an associated user account.

**Rule ID:** `SV-220293r1018571_rule`
**Severity:** medium
...
**Rule ID:** `SV-220295r1043179_rule`
**Severity:** medium
...
**Rule ID:** `SV-220305r1043188_rule`
**Severity:** medium
...
**Rule ID:** `SV-220310r1051115_rule`
**Severity:** medium
...
**Rule ID:** `SV-237697r1001008_rule`
**Severity:** high
...
**Rule ID:** `SV-237700r1043177_rule`
**Severity:** medium
...
**Rule ID:** `SV-237723r1043176_rule`
**Severity:** high
...
**Rule ID:** `SV-237724r1051115_rule`
**Severity:** medium
...
**Rule ID:** `SV-237726r1015776_rule`
**Severity:** medium
...
### Rule: The DBMS must support organizational requirements to enforce password complexity by the number of uppercase characters used.

**Rule ID:** `SV-237728r1015777_rule`
**Severity:** medium
...
### Rule: The DBMS must support organizational requirements to enforce password complexity by the number of lowercase characters used.

**Rule ID:** `SV-237729r1015778_rule`
**Severity:** medium
...
**Rule ID:** `SV-237730r1015779_rule`
**Severity:** medium
...
**Rule ID:** `SV-237731r1015780_rule`
**Severity:** medium
...
**Rule ID:** `SV-237732r1015781_rule`
**Severity:** medium
...
**Rule ID:** `SV-237733r1015782_rule`
**Severity:** medium
...
**Rule ID:** `SV-237735r1015783_rule`
**Severity:** medium
...
**Rule ID:** `SV-237738r1043182_rule`
**Severity:** medium
...
**Rule ID:** `SV-237746r1051301_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>When dealing with change control issues, it should be noted, any changes to the hardware, software, and/or firmware components of the information system and/or application can potentially have significant effects on the overall security of the system. If the application were to allow any user to make changes to software libraries, then those changes might be implemented without undergoing the appropriate testing and approvals that are part of a robust change management process. This requirement is contingent upon the language in which the application is programmed, as many application architectures in use today incorporate their software libraries into, and make them inseparable from, their compiled distributions, rendering them static and version-dependent. However, this requirement does apply to applications with software libraries accessible and configurable as in the case of interpreted languages. Accordingly, only qualified and authorized individuals must be allowed to obtain access to information system components for purposes of initiating changes, including upgrades and modifications. The DBMS software libraries contain the executables used by the DBMS to operate. Unauthorized access to the libraries can result in malicious alteration. This may in turn jeopardize data stored in the DBMS and/or operation of the host system.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
**Rule ID:** `SV-265879r1112458_rule`
**Severity:** high
...
**Check Text:**
Oracle 12c is no longer supported by the vendor. If Oracle Database version 12c is not supported by the vendor, this is a finding.
