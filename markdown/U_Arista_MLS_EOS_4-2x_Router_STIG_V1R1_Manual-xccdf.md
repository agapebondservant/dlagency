# STIG Benchmark: Arista MLS EOS 4.2x Router Security Technical Implementation Guide
...
### Rule: The Arista router must be configured to only permit management traffic that ingresses and egresses the OOBM interface.

**Rule ID:** `SV-256025r882417_rule`
**Severity:** medium
