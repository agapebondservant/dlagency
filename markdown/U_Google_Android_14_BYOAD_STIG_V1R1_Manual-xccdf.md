# STIG Benchmark: Google Android 14 BYOAD Security Technical Implementation Guide
...
### Rule: The EMM system supporting the Google Android 14 BYOAD must be configured for autonomous monitoring, compliance, and validation to ensure security/configuration settings of mobile devices do not deviate from the approved configuration baseline.

**Rule ID:** `SV-260061r948388_rule`
**Severity:** medium
...
### Rule: The EMM system supporting the Google Android 14 BYOAD must be configured to initiate autonomous monitoring, compliance, and validation prior to granting the Google Android 14 BYOAD access to DOD information and IT resources.

**Rule ID:** `SV-260062r948391_rule`
**Severity:** medium
...
### Rule: The EMM system supporting the Google Android 14 BYOAD must be configured to detect if the Google Android 14 BYOAD native security controls are disabled.

**Rule ID:** `SV-260063r948394_rule`
**Severity:** medium
...
### Rule: The EMM system supporting the Google Android 14 BYOAD must be configured to detect if known malicious applications, blocked, or prohibited applications are installed on the Google Android 14 BYOAD (DOD-managed segment only).

**Rule ID:** `SV-260064r948397_rule`
**Severity:** medium
...
### Rule: The EMM detection/monitoring system must use continuous monitoring of enrolled Google Android 14 BYOAD.

**Rule ID:** `SV-260065r948400_rule`
**Severity:** medium
...
### Rule: The Google Android 14 BYOAD must be configured to either disable access to DOD data and IT systems and user accounts or wipe the work profile if the EMM system detects that native security controls are disabled.

**Rule ID:** `SV-260066r948403_rule`
**Severity:** medium
...
### Rule: The Google Android 14 BYOAD must be configured so that the work profile is removed if the device is no longer receiving security or software updates.

**Rule ID:** `SV-260068r948409_rule`
**Severity:** medium
...
### Rule: The Google Android 14 BYOAD and DOD enterprise must be configured to limit access to only AO-approved, corporate-owned enterprise IT resources.

**Rule ID:** `SV-260069r948412_rule`
**Severity:** medium
...
### Rule: The EMM system supporting the Google Android 14 BYOAD must be NIAP validated (included on the NIAP list of compliant products or products in evaluation) unless the DOD CIO has granted an Approved Exception to Policy (E2P).

**Rule ID:** `SV-260070r948415_rule`
**Severity:** medium
...
### Rule: The DOD Mobile Service Provider must not allow Google Android 14 BYOADs in facilities where personally owned mobile devices are prohibited.

**Rule ID:** `SV-260072r948421_rule`
**Severity:** medium
...
### Rule: The Google Android 14 BYOAD must be configured to disable device cameras and/or microphones when brought into DOD facilities where mobile phone cameras and/or microphones are prohibited.

**Rule ID:** `SV-260073r948424_rule`
**Severity:** medium
...
**Rule ID:** `SV-260074r948427_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Nonapproved mobile devices may not include sufficient controls to protect work data, applications, and networks from malware or adversary attack. Components must only approve devices listed on the NIAP compliant product list or products listed in evaluation at the following links respectfully: - https://www.niap-ccevs.org/Product/ - https://www.niap-ccevs.org/Product/PINE.cfm Reference: DOD policy "Use of Non-Government Mobile Devices" (3.b.(1)i). SFR ID: FMT_SMF_EXT.1.1 #47</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
