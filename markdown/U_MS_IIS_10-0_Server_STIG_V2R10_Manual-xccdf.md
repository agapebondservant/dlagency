...
### Rule: An IIS 10.0 web server behind a load balancer or proxy server must produce log records containing the source client IP and destination information.

**Rule ID:** `SV-218787r879566_rule`
**Severity:** medium
...
### Rule: The IIS 10.0 web server must perform RFC 5280-compliant certification path validation.
