...
**Rule ID:** `SV-224820r1038967_rule`
**Severity:** medium
...
**Rule ID:** `SV-224823r1016376_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 domain-joined systems must have a Trusted Platform Module (TPM) enabled and ready for use.

**Rule ID:** `SV-224827r991589_rule`
**Severity:** medium
...
### Rule: Systems must be maintained at a supported servicing level.

**Rule ID:** `SV-224828r1059570_rule`
**Severity:** high

**Description:**
<VulnDiscussion>Systems at unsupported servicing levels will not receive security updates for new vulnerabilities, which leaves them subject to exploitation. Systems must be maintained at a servicing level supported by the vendor with new security updates.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
**Rule ID:** `SV-224837r958482_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Outdated or unused accounts provide penetration points that may go undetected. Inactive accounts must be deleted if no longer necessary or, if still required, disabled until needed. Satisfies: SRG-OS-000104-GPOS-00051, SRG-OS-000118-GPOS-00060</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2016 accounts must require passwords.
...
### Rule: Passwords must be configured to expire.

**Rule ID:** `SV-224839r1038967_rule`
**Severity:** medium
...
### Rule: The Fax Server role must not be installed.

**Rule ID:** `SV-224850r958478_rule`
**Severity:** medium
...
### Rule: The Microsoft FTP service must not be installed unless required.

**Rule ID:** `SV-224851r958480_rule`
**Severity:** medium
...
### Rule: The Peer Name Resolution Protocol must not be installed.

**Rule ID:** `SV-224852r958478_rule`
**Severity:** medium
...
### Rule: Simple TCP/IP Services must not be installed.
...
### Rule: The Telnet Client must not be installed.

**Rule ID:** `SV-224854r958480_rule`
**Severity:** medium
...
### Rule: The TFTP Client must not be installed.

**Rule ID:** `SV-224855r958478_rule`
**Severity:** medium
...
### Rule: The Server Message Block (SMB) v1 protocol must be uninstalled.

**Rule ID:** `SV-224856r958478_rule`
**Severity:** medium
...
### Rule: Windows PowerShell 2.0 must not be installed.

**Rule ID:** `SV-224859r958478_rule`
**Severity:** medium
...
### Rule: FTP servers must be configured to prevent anonymous logons.

**Rule ID:** `SV-224860r991589_rule`
**Severity:** medium
...
**Rule ID:** `SV-224862r1038944_rule`
**Severity:** low
...
### Rule: Secure Boot must be enabled on Windows Server 2016 systems.

**Rule ID:** `SV-224864r991589_rule`
**Severity:** low
...
### Rule: Windows 2016 systems must have Unified Extensible Firmware Interface (UEFI) firmware and be configured to run in UEFI mode, not Legacy BIOS.

**Rule ID:** `SV-224865r991589_rule`
**Severity:** low
...
### Rule: Windows 2016 account lockout duration must be configured to 15 minutes or greater.

**Rule ID:** `SV-224866r958736_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must have the number of allowed bad logon attempts configured to three or less.

**Rule ID:** `SV-224867r958388_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must have the period of time before the bad logon counter is reset configured to 15 minutes or greater.

**Rule ID:** `SV-224868r958388_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 password history must be configured to 24 passwords remembered.

**Rule ID:** `SV-224869r982201_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 maximum password age must be configured to 60 days or less.

**Rule ID:** `SV-224870r1038967_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 minimum password age must be configured to at least one day.

**Rule ID:** `SV-224871r982188_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 minimum password length must be configured to 14 characters.

**Rule ID:** `SV-224872r982202_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must have the built-in Windows password complexity policy enabled.

**Rule ID:** `SV-224873r982195_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>The use of complex passwords increases their strength against attack. The built-in Windows password complexity policy requires passwords to contain at least three of the four types of characters (numbers, upper- and lower-case letters, and special characters) and prevents the inclusion of user names or parts of user names. Satisfies: SRG-OS-000069-GPOS-00037, SRG-OS-000070-GPOS-00038, SRG-OS-000071-GPOS-00039, SRG-OS-000266-GPOS-00101</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2016 reversible password encryption must be disabled.

**Rule ID:** `SV-224874r982199_rule`
**Severity:** high
...
### Rule: Permissions for the Application event log must prevent access by non-privileged accounts.

**Rule ID:** `SV-224877r958434_rule`
**Severity:** medium
...
### Rule: Permissions for the Security event log must prevent access by non-privileged accounts.

**Rule ID:** `SV-224878r958434_rule`
**Severity:** medium
...
### Rule: Permissions for the System event log must prevent access by non-privileged accounts.

**Rule ID:** `SV-224879r958434_rule`
**Severity:** medium
...
### Rule: Event Viewer must be protected from unauthorized modification and deletion.

**Rule ID:** `SV-224880r991558_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Account Logon - Credential Validation successes.

**Rule ID:** `SV-224881r991578_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Account Logon - Credential Validation failures.

**Rule ID:** `SV-224882r991578_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Account Management - Other Account Management Events successes.

**Rule ID:** `SV-224883r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Account Management - Security Group Management successes.

**Rule ID:** `SV-224884r958368_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Account Management - User Account Management successes.

**Rule ID:** `SV-224885r958368_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Account Management - User Account Management failures.

**Rule ID:** `SV-224886r958368_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Detailed Tracking - Plug and Play Events successes.

**Rule ID:** `SV-224887r991583_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Detailed Tracking - Process Creation successes.

**Rule ID:** `SV-224888r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Logon/Logoff - Account Lockout failures.

**Rule ID:** `SV-224890r991552_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Logon/Logoff - Group Membership successes.

**Rule ID:** `SV-224891r991578_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Logon/Logoff - Logoff successes.

**Rule ID:** `SV-224892r958406_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Logon/Logoff - Logon successes.

**Rule ID:** `SV-224893r958406_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Logon/Logoff - Logon failures.

**Rule ID:** `SV-224894r958406_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Logon/Logoff - Special Logon successes.

**Rule ID:** `SV-224895r991578_rule`
**Severity:** medium
...
### Rule: Windows 2016 must be configured to audit Object Access - Other Object Access Events successes.

**Rule ID:** `SV-224896r991578_rule`
**Severity:** medium
...
### Rule: Windows 2016 must be configured to audit Object Access - Other Object Access Events failures.

**Rule ID:** `SV-224897r991578_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Object Access - Removable Storage successes.

**Rule ID:** `SV-224898r991583_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Object Access - Removable Storage failures.

**Rule ID:** `SV-224899r991583_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Policy Change - Audit Policy Change successes.

**Rule ID:** `SV-224900r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Policy Change - Audit Policy Change failures.

**Rule ID:** `SV-224901r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Policy Change - Authentication Policy Change successes.

**Rule ID:** `SV-224902r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Policy Change - Authorization Policy Change successes.

**Rule ID:** `SV-224903r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Privilege Use - Sensitive Privilege Use successes.

**Rule ID:** `SV-224904r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit Privilege Use - Sensitive Privilege Use failures.

**Rule ID:** `SV-224905r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit System - IPsec Driver successes.

**Rule ID:** `SV-224906r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit System - IPsec Driver failures.

**Rule ID:** `SV-224907r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit System - Other System Events successes.

**Rule ID:** `SV-224908r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit System - Other System Events failures.

**Rule ID:** `SV-224909r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit System - Security State Change successes.

**Rule ID:** `SV-224910r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit System - Security System Extension successes.

**Rule ID:** `SV-224911r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit System - System Integrity successes.

**Rule ID:** `SV-224912r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit System - System Integrity failures.

**Rule ID:** `SV-224913r958732_rule`
**Severity:** medium
...
### Rule: WDigest Authentication must be disabled on Windows Server 2016.

**Rule ID:** `SV-224915r958478_rule`
**Severity:** medium
...
### Rule: Internet Protocol version 6 (IPv6) source routing must be configured to the highest protection level to prevent IP source routing.

**Rule ID:** `SV-224916r991589_rule`
**Severity:** low
...
### Rule: Source routing must be configured to the highest protection level to prevent Internet Protocol (IP) source routing.

**Rule ID:** `SV-224917r991589_rule`
**Severity:** low
...
### Rule: Windows Server 2016 must be configured to prevent Internet Control Message Protocol (ICMP) redirects from overriding Open Shortest Path First (OSPF)-generated routes.

**Rule ID:** `SV-224918r991589_rule`
**Severity:** low
...
### Rule: Windows Server 2016 must be configured to ignore NetBIOS name release requests except from WINS servers.

**Rule ID:** `SV-224919r958902_rule`
**Severity:** low
...
### Rule: Windows Server 2016 virtualization-based security must be enabled with the platform security level configured to Secure Boot or Secure Boot with DMA Protection.
...
### Rule: Early Launch Antimalware, Boot-Start Driver Initialization Policy must prevent boot drivers identified as bad.

**Rule ID:** `SV-224924r991589_rule`
**Severity:** medium
...
### Rule: Users must be prompted to authenticate when the system wakes from sleep (on battery).

**Rule ID:** `SV-224929r991589_rule`
**Severity:** medium
...
### Rule: Users must be prompted to authenticate when the system wakes from sleep (plugged in).

**Rule ID:** `SV-224930r991589_rule`
**Severity:** medium
...
### Rule: Windows Telemetry must be configured to Security or Basic.

**Rule ID:** `SV-224936r991589_rule`
**Severity:** medium
...
### Rule: The Security event log size must be configured to 196608 KB or greater.

**Rule ID:** `SV-224938r958752_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 Windows SmartScreen must be enabled.

**Rule ID:** `SV-224940r958478_rule`
**Severity:** medium
...
### Rule: Turning off File Explorer heap termination on corruption must be disabled.

**Rule ID:** `SV-224942r991589_rule`
**Severity:** low
...
**Rule ID:** `SV-224944r1050790_rule`
**Severity:** medium
...
**Rule ID:** `SV-224946r1050790_rule`
**Severity:** medium
...
### Rule: The Remote Desktop Session Host must require secure Remote Procedure Call (RPC) communications.

**Rule ID:** `SV-224947r991554_rule`
**Severity:** medium
...
### Rule: Remote Desktop Services must be configured with the client connection encryption set to High Level.

**Rule ID:** `SV-224948r991554_rule`
**Severity:** medium
...
### Rule: The Windows Installer Always install with elevated privileges option must be disabled.

**Rule ID:** `SV-224954r982210_rule`
**Severity:** high
...
### Rule: PowerShell script block logging must be enabled.

**Rule ID:** `SV-224957r958422_rule`
**Severity:** medium
...
**Rule ID:** `SV-224963r1050790_rule`
**Severity:** medium
...
### Rule: Kerberos user logon restrictions must be enforced.

**Rule ID:** `SV-224965r958494_rule`
**Severity:** medium
...
### Rule: The Kerberos service ticket maximum lifetime must be limited to 600 minutes or less.

**Rule ID:** `SV-224966r958494_rule`
**Severity:** medium
...
### Rule: The Kerberos user ticket lifetime must be limited to 10 hours or less.
...
### Rule: The Kerberos policy user ticket renewal maximum lifetime must be limited to seven days or less.

**Rule ID:** `SV-224968r958494_rule`
**Severity:** medium
...
### Rule: The computer clock synchronization tolerance must be limited to 5 minutes or less.

**Rule ID:** `SV-224969r958494_rule`
**Severity:** medium
...
### Rule: Permissions on the Active Directory data files must only allow System and Administrators access.

**Rule ID:** `SV-224970r958726_rule`
**Severity:** high
...
### Rule: Windows Server 2016 must be configured to audit DS Access - Directory Service Access successes.

**Rule ID:** `SV-224987r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit DS Access - Directory Service Access failures.

**Rule ID:** `SV-224988r958732_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to audit DS Access - Directory Service Changes successes.

**Rule ID:** `SV-224989r958732_rule`
**Severity:** medium
...
### Rule: Domain controllers must require LDAP access signing.

**Rule ID:** `SV-224995r958908_rule`
**Severity:** medium
...
### Rule: Domain controllers must be configured to allow reset of machine account passwords.

**Rule ID:** `SV-224996r991589_rule`
**Severity:** medium
...
### Rule: The Access this computer from the network user right must only be assigned to the Administrators, Authenticated Users, and 
Enterprise Domain Controllers groups on domain controllers.

**Rule ID:** `SV-224997r958472_rule`
**Severity:** medium
...
### Rule: The Add workstations to domain user right must only be assigned to the Administrators group.

**Rule ID:** `SV-224998r958726_rule`
**Severity:** medium
...
### Rule: The Allow log on through Remote Desktop Services user right must only be assigned to the Administrators group.

**Rule ID:** `SV-224999r958472_rule`
**Severity:** medium
...
### Rule: The Deny access to this computer from the network user right on domain controllers must be configured to prevent unauthenticated access.

**Rule ID:** `SV-225000r958472_rule`
**Severity:** medium
...
### Rule: The Deny log on as a batch job user right on domain controllers must be configured to prevent unauthenticated access.

**Rule ID:** `SV-225001r958472_rule`
**Severity:** medium
...
### Rule: The Deny log on as a service user right must be configured to include no accounts or groups (blank) on domain controllers.

**Rule ID:** `SV-225002r958472_rule`
**Severity:** medium
...
### Rule: The Deny log on locally user right on domain controllers must be configured to prevent unauthenticated access.

**Rule ID:** `SV-225003r958472_rule`
**Severity:** medium
...
### Rule: The Deny log on through Remote Desktop Services user right on domain controllers must be configured to prevent unauthenticated access.

**Rule ID:** `SV-225004r958672_rule`
**Severity:** medium
...
### Rule: The Enable computer and user accounts to be trusted for delegation user right must only be assigned to the Administrators group on domain controllers.

**Rule ID:** `SV-225005r958726_rule`
**Severity:** medium
...
### Rule: Unauthenticated Remote Procedure Call (RPC) clients must be restricted from connecting to the RPC server.

**Rule ID:** `SV-225010r971545_rule`
**Severity:** medium
...
### Rule: The "Access this computer from the network" user right must only be assigned to the Administrators and Authenticated Users groups on member servers.

**Rule ID:** `SV-225014r958472_rule`
**Severity:** medium
...
### Rule: The "Deny access to this computer from the network" user right on member servers must be configured to prevent access from highly privileged domain accounts and local accounts on domain systems and from unauthenticated access on all systems.

**Rule ID:** `SV-225015r958472_rule`
**Severity:** medium
...
### Rule: The "Deny log on as a batch job" user right on member servers must be configured to prevent access from highly privileged domain accounts on domain systems and from unauthenticated access on all systems.

**Rule ID:** `SV-225016r958472_rule`
**Severity:** medium
...
### Rule: The "Deny log on as a service" user right on member servers must be configured to prevent access from highly privileged domain accounts on domain systems. No other groups or accounts must be assigned this right.

**Rule ID:** `SV-225017r958472_rule`
**Severity:** medium
...
### Rule: The "Deny log on locally" user right on member servers must be configured to prevent access from highly privileged domain accounts on domain systems and from unauthenticated access on all systems.

**Rule ID:** `SV-225018r958472_rule`
**Severity:** medium
...
### Rule: The "Deny log on through Remote Desktop Services" user right on member servers must be configured to prevent access from highly privileged domain accounts and all local accounts on domain systems and from unauthenticated access on all systems.

**Rule ID:** `SV-225019r958672_rule`
**Severity:** medium
...
### Rule: The "Enable computer and user accounts to be trusted for delegation" user right must not be assigned to any groups or accounts on member servers.

**Rule ID:** `SV-225020r958726_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 built-in guest account must be disabled.

**Rule ID:** `SV-225024r958504_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 built-in administrator account must be renamed.

**Rule ID:** `SV-225026r991589_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 built-in guest account must be renamed.

**Rule ID:** `SV-225027r991589_rule`
**Severity:** medium
...
### Rule: The setting Domain member: Digitally encrypt or sign secure channel data (always) must be configured to Enabled.

**Rule ID:** `SV-225029r958908_rule`
**Severity:** medium
...
### Rule: The setting Domain member: Digitally encrypt secure channel data (when possible) must be configured to enabled.

**Rule ID:** `SV-225030r958908_rule`
**Severity:** medium
...
### Rule: The setting Domain member: Digitally sign secure channel data (when possible) must be configured to Enabled.

**Rule ID:** `SV-225031r958908_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to require a strong session key.

**Rule ID:** `SV-225034r958908_rule`
**Severity:** medium
...
### Rule: The machine inactivity limit must be set to 15 minutes, locking the system with the screen saver.

**Rule ID:** `SV-225035r958402_rule`
**Severity:** medium
...
### Rule: The setting Microsoft network client: Digitally sign communications (always) must be configured to Enabled.

**Rule ID:** `SV-225039r958908_rule`
**Severity:** medium
...
### Rule: The setting Microsoft network client: Digitally sign communications (if server agrees) must be configured to Enabled.

**Rule ID:** `SV-225040r958908_rule`
**Severity:** medium
...
### Rule: Unencrypted passwords must not be sent to third-party Server Message Block (SMB) servers.

**Rule ID:** `SV-225041r987796_rule`
**Severity:** medium
...
### Rule: The setting Microsoft network server: Digitally sign communications (always) must be configured to Enabled.

**Rule ID:** `SV-225042r958908_rule`
**Severity:** medium
...
### Rule: The setting Microsoft network server: Digitally sign communications (if client agrees) must be configured to Enabled.

**Rule ID:** `SV-225043r958908_rule`
**Severity:** medium
...
### Rule: Anonymous enumeration of Security Account Manager (SAM) accounts must not be allowed.

**Rule ID:** `SV-225045r991589_rule`
**Severity:** high
...
### Rule: Anonymous enumeration of shares must not be allowed.

**Rule ID:** `SV-225046r958524_rule`
**Severity:** high
...
### Rule: Windows Server 2016 must be configured to prevent anonymous users from having the same permissions as the Everyone group.

**Rule ID:** `SV-225047r991589_rule`
**Severity:** medium
...
### Rule: Services using Local System that use Negotiate when reverting to NTLM authentication must use the computer identity instead of authenticating anonymously.

**Rule ID:** `SV-225049r991589_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to prevent the storage of the LAN Manager hash of passwords.

**Rule ID:** `SV-225053r982199_rule`
**Severity:** high
...
### Rule: The LAN Manager authentication level must be set to send NTLMv2 response only and to refuse LM and NTLM.

**Rule ID:** `SV-225054r991589_rule`
**Severity:** high
...
### Rule: Windows Server 2016 must be configured to at least negotiate signing for LDAP client signing.

**Rule ID:** `SV-225055r991589_rule`
**Severity:** medium
...
### Rule: Session security for NTLM SSP-based clients must be configured to require NTLMv2 session security and 128-bit encryption.

**Rule ID:** `SV-225056r991589_rule`
**Severity:** medium
...
### Rule: Session security for NTLM SSP-based servers must be configured to require NTLMv2 session security and 128-bit encryption.

**Rule ID:** `SV-225057r991589_rule`
**Severity:** medium
...
### Rule: Users must be required to enter a password to access private keys stored on the computer.

**Rule ID:** `SV-225058r958450_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured to use FIPS-compliant algorithms for encryption, hashing, and signing.

**Rule ID:** `SV-225059r958408_rule`
**Severity:** medium
...
### Rule: The default permissions of global system objects must be strengthened.

**Rule ID:** `SV-225060r991589_rule`
**Severity:** low
...
**Rule ID:** `SV-225061r1050790_rule`
**Severity:** medium
...
### Rule: UIAccess applications must not be allowed to prompt for elevation without using the secure desktop.

**Rule ID:** `SV-225062r958518_rule`
**Severity:** medium
...
### Rule: User Account Control must, at a minimum, prompt administrators for consent on the secure desktop.

**Rule ID:** `SV-225063r958518_rule`
**Severity:** medium
...
### Rule: User Account Control must automatically deny standard user requests for elevation.

**Rule ID:** `SV-225064r1050790_rule`
**Severity:** medium
...
**Rule ID:** `SV-225067r1050790_rule`
**Severity:** medium
...
### Rule: The Allow log on locally user right must only be assigned to the Administrators group.

**Rule ID:** `SV-225072r958472_rule`
**Severity:** medium
...
### Rule: The Generate security audits user right must only be assigned to Local Service and Network Service.

**Rule ID:** `SV-225081r958726_rule`
**Severity:** medium
...
### Rule: The Increase scheduling priority user right must only be assigned to the Administrators group.

**Rule ID:** `SV-225083r958726_rule`
**Severity:** medium
...
### Rule: The Windows Explorer Preview pane must be disabled for Windows Server 2016.

**Rule ID:** `SV-236000r958478_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must have PowerShell Transcription enabled.

**Rule ID:** `SV-257502r958420_rule`
**Severity:** medium
...
### Rule: Windows Server 2016 must be configured for name-based strong mappings for certificates.
