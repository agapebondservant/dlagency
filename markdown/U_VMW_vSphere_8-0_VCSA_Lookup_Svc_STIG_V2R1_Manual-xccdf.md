# STIG Benchmark: VMware vSphere 8.0 vCenter Appliance Lookup Service Security Technical Implementation Guide
...
### Rule: The vCenter Lookup service must limit the number of maximum concurrent connections permitted.

**Rule ID:** `SV-259037r960735_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service cookies must have secure flag set.

**Rule ID:** `SV-259038r960792_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must initiate session logging upon startup.

**Rule ID:** `SV-259039r960888_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must produce log records containing sufficient information regarding event details.

**Rule ID:** `SV-259040r960891_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service logs folder permissions must be set correctly.

**Rule ID:** `SV-259041r960930_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must limit privileges for creating or modifying hosted application shared files.

**Rule ID:** `SV-259042r960960_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must disable stack tracing.

**Rule ID:** `SV-259043r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must be configured to use a specified IP address and port.

**Rule ID:** `SV-259044r960966_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must be configured to limit data exposure between applications.

**Rule ID:** `SV-259045r961116_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must be configured to fail to a known safe state if system initialization fails.

**Rule ID:** `SV-259046r961122_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must set URIEncoding to UTF-8.

**Rule ID:** `SV-259047r961158_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service "ErrorReportValve showServerInfo" must be set to "false".

**Rule ID:** `SV-259048r961167_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must set an inactive timeout for sessions.

**Rule ID:** `SV-259049r1003620_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must offload log records onto a different system or media from the system being logged.

**Rule ID:** `SV-259050r961395_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must enable "STRICT_SERVLET_COMPLIANCE".

**Rule ID:** `SV-259051r961863_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must limit the amount of time that each Transmission Control Protocol (TCP) connection is kept alive.

**Rule ID:** `SV-259052r960735_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must limit the number of times that each Transmission Control Protocol (TCP) connection is kept alive.

**Rule ID:** `SV-259053r960735_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must configure the "setCharacterEncodingFilter" filter.

**Rule ID:** `SV-259054r961158_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service cookies must have "http-only" flag set.

**Rule ID:** `SV-259055r960792_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service DefaultServlet must be set to "readonly" for "PUT" and "DELETE" commands.

**Rule ID:** `SV-259056r960792_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service shutdown port must be disabled.

**Rule ID:** `SV-259057r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service debug parameter must be disabled.

**Rule ID:** `SV-259058r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service directory listings parameter must be disabled.

**Rule ID:** `SV-259059r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service deployXML attribute must be disabled.

**Rule ID:** `SV-259060r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must have Autodeploy disabled.

**Rule ID:** `SV-259061r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service xpoweredBy attribute must be disabled.

**Rule ID:** `SV-259062r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service example applications must be removed.

**Rule ID:** `SV-259063r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service default ROOT web application must be removed.

**Rule ID:** `SV-259064r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service default documentation must be removed.

**Rule ID:** `SV-259065r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service files must have permissions in an out-of-the-box state.

**Rule ID:** `SV-259066r961461_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must disable "ALLOW_BACKSLASH".

**Rule ID:** `SV-259067r961863_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service must enable "ENFORCE_ENCODING_IN_GET_WRITER".

**Rule ID:** `SV-259068r961863_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service manager webapp must be removed.

**Rule ID:** `SV-259069r960963_rule`
**Severity:** medium
...
### Rule: The vCenter Lookup service host-manager webapp must be removed.

**Rule ID:** `SV-259070r1003622_rule`
**Severity:** medium
