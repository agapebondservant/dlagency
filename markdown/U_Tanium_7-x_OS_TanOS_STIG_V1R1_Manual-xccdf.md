...
### Rule: The Tanium Operating System (TanOS) must enforce 24 hours/1 day as the maximum password lifetime.

**Rule ID:** `SV-254843r866070_rule`
**Severity:** medium
...
### Rule: The Tanium Operating System (TanOS) must prohibit password reuse for a minimum of five generations.

**Rule ID:** `SV-254845r866076_rule`
**Severity:** medium
...
### Rule: The Tanium Operating System (TanOS) must terminate all sessions and network connections when nonlocal maintenance is completed.

**Rule ID:** `SV-254850r866091_rule`
**Severity:** medium
...
**Check Text:**
1. Access the Tanium Server interactively. 2. Log on to the TanOS server with the tanadmin role. 3. Press "A" for "Appliance Configuration Menu," and then press "Enter". 4. Press "A" for "Security," and then press "Enter". 5. Press "X" for "Advanced Security," and then press "Enter". If the "Menu Timeout" setting is "-", this is a finding.
...
### Rule: The Tanium Operating System (TanOS) must notify system administrators and ISSOs when accounts are created.

**Rule ID:** `SV-254856r870379_rule`
**Severity:** medium
...
### Rule: The Tanium Operating System (TanOS) must audit and notify system administrators and ISSOs when accounts are modified.

**Rule ID:** `SV-254857r870380_rule`
**Severity:** medium
...
### Rule: The Tanium Operating System (TanOS) must notify system administrators and ISSOs when accounts are removed.

**Rule ID:** `SV-254858r866115_rule`
**Severity:** medium
...
### Rule: Tanium must audit and notify system administrators and ISSOs when accounts are enabled.

**Rule ID:** `SV-254860r870381_rule`
**Severity:** medium
...
### Rule: The Tanium Operating System (TanOS) must protect against or limit the effects of denial of service (DoS) attacks by employing organization-defined security safeguards.

**Rule ID:** `SV-254870r866151_rule`
**Severity:** medium
...
### Rule: The Tanium operating system (TanOS) must install security-relevant firmware updates within the time period directed by an authoritative source (e.g. IAVM, CTOs, DTMs, and STIGs).

**Rule ID:** `SV-254872r866157_rule`
**Severity:** medium
