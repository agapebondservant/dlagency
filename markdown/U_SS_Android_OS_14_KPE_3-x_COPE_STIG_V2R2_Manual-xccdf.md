# STIG Benchmark: Samsung Android OS 14 with Knox 3.x COPE Security Technical Implementation Guide
...
**Rule ID:** `SV-258665r1015816_rule`
**Severity:** medium
...
**Rule ID:** `SV-258667r1015817_rule`
**Severity:** medium
...
**Rule ID:** `SV-258670r1015818_rule`
**Severity:** medium
...
**Rule ID:** `SV-258671r1015819_rule`
**Severity:** medium
...
**Rule ID:** `SV-258681r1032950_rule`
**Severity:** medium
...
**Rule ID:** `SV-258691r1042493_rule`
**Severity:** medium
...
### Rule: The Samsung Android device work profile must be configured to disable automatic completion of work space internet browser text input.

**Rule ID:** `SV-258697r959010_rule`
**Severity:** medium
