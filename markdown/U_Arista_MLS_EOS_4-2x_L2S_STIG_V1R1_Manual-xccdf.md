# STIG Benchmark: Arista MLS EOS 4.2x L2S Security Technical Implementation Guide
...
### Rule: The Arista MLS layer 2 switch must enable Unidirectional Link Detection (UDLD) to protect against one-way connections.

**Rule ID:** `SV-255978r882276_rule`
**Severity:** medium
