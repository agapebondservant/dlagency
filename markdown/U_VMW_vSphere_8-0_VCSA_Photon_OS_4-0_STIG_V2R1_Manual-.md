...
**Check Text:**
At the command line, run the following command to verify a 90-day maximum password lifetime restriction: # grep '^PASS_MAX_DAYS' /etc/login.defs If "PASS_MAX_DAYS" is not set to <= 90, is missing or commented out, this is a finding. If "PASS_MAX_DAYS" is disabled or set to -1, this is a finding.
...
**Rule ID:** `SV-258838r1003642_rule`
**Severity:** medium
...
**Rule ID:** `SV-258840r1003643_rule`
**Severity:** medium
...
**Rule ID:** `SV-258842r1003645_rule`
**Severity:** medium
...
**Rule ID:** `SV-258846r1003646_rule`
**Severity:** high
...
**Rule ID:** `SV-258847r1003647_rule`
**Severity:** medium
...
**Rule ID:** `SV-258862r1003649_rule`
**Severity:** medium
...
**Check Text:**
At the command line, run the following command to verify account locking persists lockouts between system reboots # grep '^dir' /etc/security/faillock.conf Example result: dir = /var/log/faillock If the "dir" option is set to "/var/run/faillock", this is a finding. If the "dir" option is not set to a persistent documented faillock directory, is missing or commented out, this is a finding. Note: If faillock.conf is not used to configure pam_faillock.so, these options may be specified on the faillock lines in the system-auth and system-account files.
...
**Rule ID:** `SV-258863r1003650_rule`
**Severity:** medium
...
**Rule ID:** `SV-258864r1003651_rule`
**Severity:** high
...
**Rule ID:** `SV-258869r1003654_rule`
**Severity:** medium
...
**Rule ID:** `SV-258902r1003655_rule`
**Severity:** medium
...
### Rule: The Photon operating system must configure AIDE to detect changes to baseline configurations.

**Rule ID:** `SV-266062r1003658_rule`
**Severity:** medium
...
### Rule: The Photon operating system must not allow empty passwords.

**Rule ID:** `SV-266063r1003661_rule`
**Severity:** medium
