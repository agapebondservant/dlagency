# STIG Benchmark: Multifunction Device and Network Printers Security Technical Implemetation Guide
...
## Group: MFD Protocol TCP/IP

**Group ID:** `V-6777`

### Rule: The MFD or Network Printer must not enable network protocols other than TCP/IP.

**Rule ID:** `SV-6999r2_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>The greater the number of protocols allowed active on the network the more vulnerabilities there will be available to be exploited. This also prevents accidental implementation of a “call-home” feature that is not allowed.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
## Group: MFD/Printer Firewall/Router Rule Perimeter

**Group ID:** `V-6779`

### Rule: A firewall or router rule must block all ingress and egress traffic from the enclave perimeter to the MFD or Network Printer.
...
### Rule: The MFD or Network Printer must employ the most current firmware available.
...
## Group: MFD SNMP Community Strings 

**Group ID:** `V-6781`

### Rule: The default passwords and SNMP community strings of all management services have not been  replaced with complex passwords.
...
## Group: MFD Configuration State After Power Down or Reboot

**Group ID:** `V-6782`

### Rule: The MFD or Network Printer must maintain configuration state (e.g., passwords, service settings) after a power down or restart.
...
## Group: MFD Management Protocols

**Group ID:** `V-6783`

### Rule: Management protocols, with the exception of HTTPS and SNMPv3, must be disabled at all times except when necessary.
...
## Group:  MFD or a printer can be managed from any IP

**Group ID:** `V-6784`

### Rule: There is no restriction on where a MFD or a printer can be remotely managed.
...
## Group: Print Services Restricted to Port 9100 and/or LPD

**Group ID:** `V-6790`

### Rule: Print services for a MFD or printer are not restricted to Port 9100 and/or LPD (Port 515).
...
## Group: MFD/Printer Restrict Jobs Only From Print Spooler

**Group ID:** `V-6794`

### Rule: A MFD or printer is not configured to restrict jobs to those from print spoolers.


**Rule ID:** `SV-7019r3_rule`
**Severity:** medium
...
## Group: MFD Authorized Users Restrictions

**Group ID:** `V-6796`

### Rule: Print spoolers are  not configured to restrict access to authorized users and restrict users to managing their own individual jobs. 
...
## Group: MFD and Spooler Auditing

**Group ID:** `V-6797`

### Rule: The devices and their spoolers do not have auditing enabled. 
...
## Group: MFD/Printer Security Policy 

**Group ID:** `V-6798`

### Rule: Implementation of an MFD and printer security policy for the protection of classified information. 

**Rule ID:** `SV-7023r3_rule`
**Severity:** low
...
## Group: MFD Level of Audit and Reviewing

**Group ID:** `V-6799`

### Rule: The level of audit has not been established or the audit logs being collected for the devices and print spoolers are not being reviewed.
...
## Group: MFD Classified Network

**Group ID:** `V-6800`

### Rule: MFDs with print, copy, scan, or fax capabilities must be prohibited on classified networks without the approval of the DAA.
...
## Group: MFD Clearing Disk Space Scan to Disk

**Group ID:** `V-6801`

### Rule: A MFD device, with scan to hard disk functionality used, is not configured to clear the hard disk between jobs.
...
## Group: MFD Scan Discretionary Access Control

**Group ID:** `V-6802`

### Rule: Scan to a file share is enabled but the file shares do not have the appropriate discretionary access control list in place.
...
## Group: MFD fax from network auditing

**Group ID:** `V-6803`

### Rule: Auditing of user access and fax logs must be enabled when fax from the network is enabled.
...
## Group: MFD scan to SMTP (email)

**Group ID:** `V-6804`

### Rule: MFDs must not allow scan to SMTP (email).
...
## Group: MFD Hard Drive Lock

**Group ID:** `V-6805`

### Rule: A MFD device does not have a mechanism to lock and prevent access to the hard drive.
...
## Group: MFD/Printer Global Configuration Settings

**Group ID:** `V-6806`

### Rule: The device is not configured to prevent non-printer administrators from altering the global configuration of the device.
...
### Rule: The MFD must be configured to prohibit the use of all unnecessary and/or nonsecure functions, physical and logical ports, protocols, and/or services.

**Rule ID:** `SV-106815r1_rule`
**Severity:** medium
