...
**Rule ID:** `SV-255301r1043176_rule`
**Severity:** high
...
**Rule ID:** `SV-255302r1112451_rule`
**Severity:** high
...
**Check Text:**
Review the system documentation to determine the required levels of protection for securables in the database, by type of login. Review the permissions actually in place on the server. Execute the supplemental script, "ASQL-00-000200-SERVER.sql" to find permissions assigned. If the actual permissions do not match the documented requirements, this is a finding.
...
**Rule ID:** `SV-255303r1112454_rule`
**Severity:** high
...
**Check Text:**
Review the system documentation to determine the required levels of protection for securables in the database, by type of user. Review the permissions actually in place on the database. Execute the supplemental script, "ASQL-00-000300-DATABASE.sql" to find permissions in place on the database. If the actual permissions do not match the documented requirements, this is a finding.
...
**Rule ID:** `SV-255311r1112455_rule`
**Severity:** medium
...
**Rule ID:** `SV-255312r1112456_rule`
**Severity:** medium
...
**Rule ID:** `SV-255318r1018606_rule`
**Severity:** medium
...
**Rule ID:** `SV-255321r1018558_rule`
**Severity:** high
...
**Rule ID:** `SV-255322r1018559_rule`
**Severity:** high
...
**Rule ID:** `SV-255334r1043177_rule`
**Severity:** medium
...
**Rule ID:** `SV-255335r1051115_rule`
**Severity:** medium
...
**Rule ID:** `SV-255340r1043182_rule`
**Severity:** medium
...
**Rule ID:** `SV-255345r1018607_rule`
**Severity:** medium
