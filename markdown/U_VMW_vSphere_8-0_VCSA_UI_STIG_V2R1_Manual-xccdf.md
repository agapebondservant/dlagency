# STIG Benchmark: VMware vSphere 8.0 vCenter Appliance User Interface (UI) Security Technical Implementation Guide
...
### Rule: The vCenter UI service must limit the number of maximum concurrent connections permitted.

**Rule ID:** `SV-259104r960735_rule`
**Severity:** medium
...
### Rule: The vCenter UI service cookies must have secure flag set.

**Rule ID:** `SV-259105r960792_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must initiate session logging upon startup.

**Rule ID:** `SV-259106r960888_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must produce log records containing sufficient information regarding event details.

**Rule ID:** `SV-259107r960891_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must protect logs from unauthorized access.

**Rule ID:** `SV-259108r960930_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must limit privileges for creating or modifying hosted application shared files.

**Rule ID:** `SV-259109r960960_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must disable stack tracing.

**Rule ID:** `SV-259110r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must be configured to use a specified IP address and port.

**Rule ID:** `SV-259111r960966_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must be configured to limit data exposure between applications.

**Rule ID:** `SV-259112r961116_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must be configured to fail to a known safe state if system initialization fails.

**Rule ID:** `SV-259113r961122_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must set URIEncoding to UTF-8.

**Rule ID:** `SV-259114r961158_rule`
**Severity:** medium
...
### Rule: The vCenter UI service "ErrorReportValve showServerInfo" must be set to "false".

**Rule ID:** `SV-259115r961167_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must set an inactive timeout for sessions.

**Rule ID:** `SV-259116r1003678_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must offload log records onto a different system or media from the system being logged.

**Rule ID:** `SV-259117r961395_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must enable "STRICT_SERVLET_COMPLIANCE".

**Rule ID:** `SV-259118r961863_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must limit the amount of time that each Transmission Control Protocol (TCP) connection is kept alive.

**Rule ID:** `SV-259119r960735_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must limit the number of times that each Transmission Control Protocol (TCP) connection is kept alive.

**Rule ID:** `SV-259120r960735_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must configure the "setCharacterEncodingFilter" filter.

**Rule ID:** `SV-259121r961158_rule`
**Severity:** medium
...
### Rule: The vCenter UI service cookies must have "http-only" flag set.

**Rule ID:** `SV-259122r960792_rule`
**Severity:** medium
...
### Rule: The vCenter UI service DefaultServlet must be set to "readonly" for "PUT" and "DELETE" commands.

**Rule ID:** `SV-259123r960792_rule`
**Severity:** medium
...
### Rule: The vCenter UI service shutdown port must be disabled.

**Rule ID:** `SV-259124r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service debug parameter must be disabled.

**Rule ID:** `SV-259125r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service directory listings parameter must be disabled.

**Rule ID:** `SV-259126r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service deployXML attribute must be disabled.

**Rule ID:** `SV-259127r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must have Autodeploy disabled.

**Rule ID:** `SV-259128r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service xpoweredBy attribute must be disabled.

**Rule ID:** `SV-259129r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service example applications must be removed.

**Rule ID:** `SV-259130r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service default ROOT web application must be removed.

**Rule ID:** `SV-259131r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service default documentation must be removed.

**Rule ID:** `SV-259132r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must disable "ALLOW_BACKSLASH".

**Rule ID:** `SV-259133r961863_rule`
**Severity:** medium
...
### Rule: The vCenter UI service must enable "ENFORCE_ENCODING_IN_GET_WRITER".

**Rule ID:** `SV-259134r961863_rule`
**Severity:** medium
...
### Rule: The vCenter UI service manager webapp must be removed.

**Rule ID:** `SV-259135r960963_rule`
**Severity:** medium
...
### Rule: The vCenter UI service host-manager webapp must be removed.

**Rule ID:** `SV-259136r1003680_rule`
**Severity:** medium
