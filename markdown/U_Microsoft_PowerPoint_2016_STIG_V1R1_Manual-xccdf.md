# STIG Benchmark: Microsoft PowerPoint 2016 Security Technical Implementation Guide
...
### Rule: Disabling of user name and password syntax from being used in URLs must be enforced in PowerPoint.
...
### Rule: The Internet Explorer Bind to Object functionality must be enabled in PowerPoint.
...
### Rule: The Saved from URL mark must be selected to enforce Internet zone processing in PowerPoint.
...
### Rule: Add-on Management functionality must be allowed in PowerPoint.
...
### Rule: Links that invoke instances of Internet Explorer from within an Office product must be blocked in PowerPoint.
...
### Rule: File Downloads must be configured for proper restrictions in PowerPoint.
...
**Description:**
<VulnDiscussion>This policy setting governs the default format for new presentation files that users create. If you enable this policy setting, when a user creates a new blank presentation, it is in the specified default format. Users may still override the default and specify a specific format when they create a presentation. If you disable or do not configure this policy setting, PowerPoint Presentation is the default option. </VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Protection from zone elevation must be enforced in PowerPoint.
...
### Rule: ActiveX Installs must be configured for proper restriction in PowerPoint.
...
### Rule: The ability to run programs from a PowerPoint presentation must be disallowed.
...
### Rule: Attachments opened from Outlook must be in Protected View.
...
### Rule: Disabling of user name and password syntax from being used in URLs must be enforced in PowerPoint Viewer.
...
### Rule: The Internet Explorer Bind to Object functionality must be enabled in PowerPoint Viewer.
...
### Rule: The Saved from URL mark must be selected to enforce Internet zone processing in PowerPoint Viewer.
...
### Rule: Navigation to URLs embedded in Office products must be blocked in PowerPoint Viewer.
...
### Rule: Scripted Window Security must be enforced in PowerPoint Viewer.
...
### Rule: Add-on Management functionality must be allowed in PowerPoint Viewer.
...
### Rule: Links that invoke instances of Internet Explorer from within an Office product must be blocked in PowerPoint Viewer.
...
### Rule: Protection from zone elevation must be enforced in PowerPoint Viewer.
...
### Rule: ActiveX Installs must be configured for proper restriction in PowerPoint Viewer.
...
### Rule: Navigation to URLs embedded in Office products must be blocked in PowerPoint.
...
### Rule: Scripted Window Security must be enforced in PowerPoint.
...
### Rule: File Downloads must be configured for proper restrictions in PowerPoint Viewer.
