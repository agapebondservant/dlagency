# STIG Benchmark: VMware vSphere 8.0 vCenter Appliance Management Interface (VAMI) Security Technical Implementation Guide
...
### Rule: The vCenter VAMI service must limit the number of allowed simultaneous session requests.

**Rule ID:** `SV-259137r935315_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must use cryptography to protect the integrity of remote sessions.

**Rule ID:** `SV-259138r935318_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must generate information to monitor remote access.

**Rule ID:** `SV-259139r935321_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must produce log records containing sufficient information to establish what type of events occurred.

**Rule ID:** `SV-259140r935324_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service log files must only be accessible by privileged users.

**Rule ID:** `SV-259141r935327_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must off-load log records onto a different system or media from the system being logged.

**Rule ID:** `SV-259142r935330_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Protection of log data includes assuring log data is not accidentally lost or deleted. Backing up log records to an unrelated system or onto separate media than the system the web server is actually running on helps to assure that, in the event of a catastrophic system failure, the log records will be retained. Satisfies: SRG-APP-000125-WSR-000071, SRG-APP-000358-WSR-000063, SRG-APP-000358-WSR-000163</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: The vCenter VAMI service must explicitly disable Multipurpose Internet Mail Extensions (MIME) mime mappings based on "Content-Type".

**Rule ID:** `SV-259143r935333_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must have resource mappings set to disable the serving of certain file types.

**Rule ID:** `SV-259144r935336_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must have Web Distributed Authoring (WebDAV) disabled.

**Rule ID:** `SV-259145r935339_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must protect system resources and privileged operations from hosted applications.

**Rule ID:** `SV-259146r935342_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must restrict access to the web server's private key.

**Rule ID:** `SV-259147r935345_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must enable FIPS mode.

**Rule ID:** `SV-259148r935348_rule`
**Severity:** high
...
### Rule: The vCenter VAMI service must restrict the ability of users to launch Denial of Service (DoS) attacks against other information systems or networks.

**Rule ID:** `SV-259149r935351_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must set the encoding for all text mime types to UTF-8.

**Rule ID:** `SV-259150r935354_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must disable directory listing.

**Rule ID:** `SV-259151r935357_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must not be configured to use the "mod_status" module.

**Rule ID:** `SV-259152r935360_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must have debug logging disabled.

**Rule ID:** `SV-259153r935363_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must enable honoring the SSL cipher order.

**Rule ID:** `SV-259154r935366_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must disable client initiated TLS renegotiation.

**Rule ID:** `SV-259155r935369_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must be configured to hide the server type and version in client responses.

**Rule ID:** `SV-259156r935372_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must implement HTTP Strict Transport Security (HSTS).

**Rule ID:** `SV-259157r935375_rule`
**Severity:** medium
...
### Rule: The vCenter VAMI service must enable Content Security Policy.

**Rule ID:** `SV-259160r935384_rule`
**Severity:** medium
