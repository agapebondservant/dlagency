# STIG Benchmark: Samsung Android 14 BYOAD Security Technical Implementation Guide
...
### Rule: The EMM system supporting the Samsung Android 14 BYOAD must be configured for autonomous monitoring, compliance, and validation to ensure security/configuration settings of mobile devices do not deviate from the approved configuration baseline.

**Rule ID:** `SV-260397r950702_rule`
**Severity:** medium
...
### Rule: The EMM system supporting the Samsung Android 14 BYOAD must be configured to initiate autonomous monitoring, compliance, and validation prior to granting the Samsung Android 14 BYOAD access to DOD information and IT resources.

**Rule ID:** `SV-260398r950705_rule`
**Severity:** medium
...
### Rule: The EMM system supporting the Samsung Android 14 BYOAD must be configured to detect if the Samsung Android 14 BYOAD native security controls are disabled.

**Rule ID:** `SV-260399r950708_rule`
**Severity:** medium
...
### Rule: The EMM system supporting the Samsung Android 14 BYOAD must be configured to detect if known malicious applications, blocked, or prohibited applications are installed on the Samsung Android 14 BYOAD (DOD-managed segment only).

**Rule ID:** `SV-260400r950711_rule`
**Severity:** medium
...
### Rule: The EMM detection/monitoring system must use continuous monitoring of enrolled Samsung Android 14 BYOAD.

**Rule ID:** `SV-260401r950714_rule`
**Severity:** medium
...
### Rule: The Samsung Android 14 BYOAD must be configured to either disable access to DOD data and IT systems and user accounts or wipe the work profile if the EMM system detects native security controls are disabled.

**Rule ID:** `SV-260402r950717_rule`
**Severity:** medium
...
### Rule: The Samsung Android 14 BYOAD must be configured so that the work profile is removed if the device is no longer receiving security or software updates.

**Rule ID:** `SV-260404r950723_rule`
**Severity:** medium
...
### Rule: The Samsung Android 14 BYOAD and DOD enterprise must be configured to limit access to only AO-approved, corporate-owned enterprise IT resources.

**Rule ID:** `SV-260405r950726_rule`
**Severity:** high
...
### Rule: The EMM system supporting the Samsung Android 14 BYOAD must be NIAP validated (included on the NIAP list of compliant products or products in evaluation) unless the DOD CIO has granted an Approved Exception to Policy (E2P).

**Rule ID:** `SV-260406r950729_rule`
**Severity:** high
...
### Rule: The DOD Mobile Service Provider must not allow Samsung Android 14 BYOADs in facilities where personally owned mobile devices are prohibited.

**Rule ID:** `SV-260408r950735_rule`
**Severity:** medium
...
### Rule: The Samsung Android 14 BYOAD must be configured to disable device cameras and/or microphones when brought into DOD facilities where mobile phone cameras and/or microphones are prohibited.

**Rule ID:** `SV-260409r950738_rule`
**Severity:** medium
