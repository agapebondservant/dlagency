# STIG Benchmark: Apple iOS/iPadOS 16 BYOAD Security Technical Implementation Guide
...
### Rule: The Apple iOS/iPadOS 16 allow list must be configured to not include applications with the following characteristics: 
...
**Rule ID:** `SV-257113r1032950_rule`
**Severity:** medium
...
### Rule: The Apple iOS/iPadOS 16 device User Agreement must include the DOD advisory warning message.

**Rule ID:** `SV-257116r958390_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 16 must be configured to wipe enterprise data and apps upon unenrollment from MDM.

**Rule ID:** `SV-257119r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 16 must not allow DOD applications to access non-DOD data.

**Rule ID:** `SV-257134r959010_rule`
**Severity:** medium
...
**Rule ID:** `SV-274442r1099859_rule`
**Severity:** high
