# STIG Benchmark: Microsoft Windows Server 2025 
...
### Rule: Windows Server 2025 must install security-relevant software updates within the time period directed by an authoritative source (e.g., IAVM, CTOs, DTMs, and STIGs).

**Rule ID:** `SV-277982r1128986_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must prohibit the use or connection of unauthorized hardware components.

**Rule ID:** `SV-277983r1128989_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must synchronize system clocks within and between systems or system components with a government-approved time source.

**Rule ID:** `SV-277984r1128992_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 users with Administrative privileges must have separate accounts for administrative duties and normal operational tasks.

**Rule ID:** `SV-277985r1128995_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 passwords for the built-in Administrator account must be changed at least every 60 days.

**Rule ID:** `SV-277986r1130124_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 administrative accounts must not be used with applications that access the internet, such as web browsers, or with potential internet sources, such as email.

**Rule ID:** `SV-277987r1129001_rule`
**Severity:** high
...
### Rule: Windows Server 2025 members of the Backup Operators group must have separate accounts for backup duties and normal operational tasks.

**Rule ID:** `SV-277988r1130126_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 manually managed application account passwords must be at least 15 characters in length.

**Rule ID:** `SV-277989r1130128_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 manually managed application account passwords must be changed at least annually or when a system administrator with knowledge of the password leaves the organization.

**Rule ID:** `SV-277990r1130130_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 shared user accounts must not be permitted.

**Rule ID:** `SV-277991r1130132_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must employ a deny-all, permit-by-exception policy to allow the execution of authorized software programs.

**Rule ID:** `SV-277992r1130135_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Using a whitelist provides a configuration management method to allow the execution of only authorized software. Using only authorized software decreases risk by limiting the number of potential vulnerabilities. The organization must identify authorized software programs and only permit execution of authorized software. The process used to identify software programs that are authorized to execute on organizational information systems is commonly referred to as whitelisting.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2025 domain-joined systems must have a Trusted Platform Module (TPM) enabled and ready for use.

**Rule ID:** `SV-277993r1130137_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Credential Guard uses virtualization-based security to protect data that could be used in credential theft attacks if compromised. A number of system requirements must be met for Credential Guard to be configured and enabled properly. Without a TPM enabled and ready for use, Credential Guard keys are stored in a less secure method using software.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2025 must be maintained at a supported servicing level.

**Rule ID:** `SV-277994r1129022_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must use an antivirus program.

**Rule ID:** `SV-277995r1129025_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have a host-based intrusion detection or prevention system.

**Rule ID:** `SV-277996r1129028_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 local volumes must use a format that supports NTFS attributes.

**Rule ID:** `SV-277997r1129031_rule`
**Severity:** high
...
### Rule: Windows Server 2025 permissions for the system drive root directory (usually C:\) must conform to minimum requirements.

**Rule ID:** `SV-277998r1129034_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Changing the system's file and directory permissions allows the possibility of unauthorized and anonymous modification to the operating system and installed applications. The default permissions are adequate when the Security Option "Network access: Let Everyone permissions apply to anonymous users" is set to "Disabled" (WN25-SO-000240). Satisfies: SRG-OS-000312-GPOS-00122, SRG-OS-000312-GPOS-00123, SRG-OS-000312-GPOS-00124</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2025 permissions for program file directories must conform to minimum requirements.

**Rule ID:** `SV-277999r1129037_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 permissions for the Windows installation directory must conform to minimum requirements.

**Rule ID:** `SV-278000r1129040_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 default permissions for the HKEY_LOCAL_MACHINE registry hive must be maintained.

**Rule ID:** `SV-278001r1129043_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 nonadministrative accounts or groups must only have print permissions on printer shares.

**Rule ID:** `SV-278002r1130139_rule`
**Severity:** low
...
### Rule: Windows Server 2025 outdated or unused accounts must be removed or disabled.

**Rule ID:** `SV-278003r1130141_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Outdated or unused accounts provide penetration points that may go undetected. Inactive accounts must be deleted if no longer necessary or, if still required, disabled until needed. Satisfies: SRG-OS-000118-GPOS-00060, SRG-OS-000590-GPOS-00110</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2025 accounts must require passwords.

**Rule ID:** `SV-278004r1129052_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 passwords must be configured to expire.

**Rule ID:** `SV-278005r1129055_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 system files must be monitored for unauthorized changes.

**Rule ID:** `SV-278006r1129058_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 nonsystem-created file shares must limit access to groups that require it.

**Rule ID:** `SV-278007r1130143_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have software certificate installation files removed.

**Rule ID:** `SV-278008r1129064_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 systems requiring data at rest protections must employ cryptographic mechanisms to prevent unauthorized disclosure and modification of the information at rest.

**Rule ID:** `SV-278009r1129067_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must implement protection methods such as TLS, encrypted VPNs, or IPsec if the data owner has a strict requirement for ensuring data integrity and confidentiality is maintained at every step of the data transfer and handling process.

**Rule ID:** `SV-278010r1129070_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the roles and features required by the system documented.

**Rule ID:** `SV-278011r1129073_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have a host-based firewall installed and enabled.

**Rule ID:** `SV-278012r1129076_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must automatically remove or disable temporary user accounts after 72 hours.

**Rule ID:** `SV-278013r1130145_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must automatically remove or disable emergency accounts after the crisis is resolved or within 72 hours.

**Rule ID:** `SV-278014r1130147_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have the Fax Server role installed.

**Rule ID:** `SV-278015r1129085_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have the Microsoft FTP service installed unless required by the organization.

**Rule ID:** `SV-278016r1130149_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have Wi-Fi enabled unless required by the organization.

**Rule ID:** `SV-278017r1129091_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have Bluetooth enabled unless required by the organization.

**Rule ID:** `SV-278018r1129094_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have the Peer Name Resolution Protocol installed.

**Rule ID:** `SV-278019r1129097_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have Simple TCP/IP Services installed.

**Rule ID:** `SV-278020r1129100_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have the Telnet Client installed.

**Rule ID:** `SV-278021r1129103_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have the TFTP Client installed.

**Rule ID:** `SV-278022r1129106_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have the Server Message Block (SMB) v1 protocol installed.

**Rule ID:** `SV-278023r1130151_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the Server Message Block (SMB) v1 protocol disabled on the SMB server.

**Rule ID:** `SV-278024r1130153_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the Server Message Block (SMB) v1 protocol disabled on the SMB client.

**Rule ID:** `SV-278025r1130155_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not have Windows PowerShell 2.0 installed.

**Rule ID:** `SV-278026r1129118_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 FTP servers must be configured to prevent anonymous logons.

**Rule ID:** `SV-278027r1130157_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 FTP servers must be configured to prevent access to the system drive.

**Rule ID:** `SV-278028r1130159_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 time service must synchronize with an appropriate DOD time source.

**Rule ID:** `SV-278029r1129127_rule`
**Severity:** low
...
### Rule: Windows Server 2025 must have orphaned security identifiers (SIDs) removed from user rights.

**Rule ID:** `SV-278030r1129130_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 systems must have Unified Extensible Firmware Interface (UEFI) firmware and be configured to run in UEFI mode, not Legacy BIOS.

**Rule ID:** `SV-278031r1129133_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have Secure Boot enabled.

**Rule ID:** `SV-278032r1129136_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the number of allowed bad logon attempts configured to three or less.

**Rule ID:** `SV-278034r1129142_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the period of time before the bad logon counter is reset configured to 15 minutes or greater.

**Rule ID:** `SV-278035r1129145_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 password history must be configured to 24 passwords remembered.

**Rule ID:** `SV-278036r1129148_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 maximum password age must be configured to 60 days or less.

**Rule ID:** `SV-278037r1129151_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 minimum password age must be configured to at least one day.

**Rule ID:** `SV-278038r1129154_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the built-in Windows password complexity policy enabled.

**Rule ID:** `SV-278039r1129157_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 reversible password encryption must be disabled.

**Rule ID:** `SV-278040r1129160_rule`
**Severity:** high
...
### Rule: Windows Server 2025 audit records must be backed up to a different system or media than the system being audited.

**Rule ID:** `SV-278041r1129163_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must, at a minimum, off-load audit records of interconnected systems in real time and off-load standalone or nondomain joined systems weekly.

**Rule ID:** `SV-278042r1129166_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 permissions for the Application event log must prevent access by nonprivileged accounts.

**Rule ID:** `SV-278043r1129169_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 permissions for the Security event log must prevent access by nonprivileged accounts.

**Rule ID:** `SV-278044r1129172_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 permissions for the System event log must prevent access by nonprivileged accounts.

**Rule ID:** `SV-278045r1129175_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Event Viewer must be protected from unauthorized modification and deletion.

**Rule ID:** `SV-278046r1129178_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Account Logon - Credential Validation successes.

**Rule ID:** `SV-278047r1129181_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Account Logon - Credential Validation failures.

**Rule ID:** `SV-278048r1129184_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Account Management - Other Account Management Events successes.

**Rule ID:** `SV-278049r1129187_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Account Management - Security Group Management successes.

**Rule ID:** `SV-278050r1129190_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Account Management - User Account Management successes.

**Rule ID:** `SV-278051r1129193_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Account Management - User Account Management failures.

**Rule ID:** `SV-278052r1129196_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Detailed Tracking - Plug and Play Events successes.

**Rule ID:** `SV-278053r1129199_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Detailed Tracking - Process Creation successes.

**Rule ID:** `SV-278054r1129202_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Logon/Logoff - Account Lockout successes.

**Rule ID:** `SV-278055r1129205_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Logon/Logoff - Account Lockout failures.

**Rule ID:** `SV-278056r1129208_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Logon/Logoff - Group Membership successes.

**Rule ID:** `SV-278057r1129211_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit logoff successes.

**Rule ID:** `SV-278058r1129214_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit logon successes.

**Rule ID:** `SV-278059r1129217_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit logon failures.

**Rule ID:** `SV-278060r1129220_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Logon/Logoff - Special Logon successes.

**Rule ID:** `SV-278061r1129223_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Object Access - Other Object Access Events successes.

**Rule ID:** `SV-278062r1129226_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Object Access - Other Object Access Events failures.

**Rule ID:** `SV-278063r1129229_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Object Access - Removable Storage successes.

**Rule ID:** `SV-278064r1129232_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Object Access - Removable Storage failures.

**Rule ID:** `SV-278065r1129235_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Policy Change - Audit Policy Change successes.

**Rule ID:** `SV-278066r1129238_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Policy Change - Audit Policy Change failures.

**Rule ID:** `SV-278067r1129241_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Policy Change - Authentication Policy Change successes.

**Rule ID:** `SV-278068r1129244_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Policy Change - Authorization Policy Change successes.

**Rule ID:** `SV-278069r1129247_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Privilege Use - Sensitive Privilege Use successes.

**Rule ID:** `SV-278070r1129250_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Privilege Use - Sensitive Privilege Use failures.

**Rule ID:** `SV-278071r1129253_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit System - IPsec Driver successes.

**Rule ID:** `SV-278072r1129256_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit System - IPsec Driver failures.

**Rule ID:** `SV-278073r1129259_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit System - Other System Events successes.

**Rule ID:** `SV-278074r1129262_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit System - Other System Events failures.

**Rule ID:** `SV-278075r1129265_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit System - Security State Change successes.

**Rule ID:** `SV-278076r1129268_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit System - Security System Extension successes.

**Rule ID:** `SV-278077r1129271_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit System - System Integrity successes.

**Rule ID:** `SV-278078r1129274_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit System - System Integrity failures.

**Rule ID:** `SV-278079r1129277_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must prevent the display of slide shows on the lock screen.

**Rule ID:** `SV-278080r1129280_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have WDigest Authentication disabled.

**Rule ID:** `SV-278081r1129283_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>When the WDigest Authentication protocol is enabled, plain-text passwords are stored in the Local Security Authority Subsystem Service (LSASS), exposing them to theft. WDigest is disabled by default in Windows Server 2025. This setting ensures this is enforced.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2025 Internet Protocol version 6 (IPv6) source routing must be configured to the highest protection level to prevent IP source routing.

**Rule ID:** `SV-278082r1129286_rule`
**Severity:** low
...
### Rule: Windows Server 2025 source routing must be configured to the highest protection level to prevent Internet Protocol (IP) source routing.

**Rule ID:** `SV-278083r1129289_rule`
**Severity:** low
...
### Rule: Windows Server 2025 must be configured to prevent Internet Control Message Protocol (ICMP) redirects from overriding Open Shortest Path First (OSPF)-generated routes.

**Rule ID:** `SV-278084r1129292_rule`
**Severity:** low
...
### Rule: Windows Server 2025 must be configured to ignore NetBIOS name release requests except from WINS servers.

**Rule ID:** `SV-278085r1129295_rule`
**Severity:** low
...
### Rule: Windows Server 2025 insecure logons to an SMB server must be disabled.

**Rule ID:** `SV-278086r1129298_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 hardened Universal Naming Convention (UNC) paths must be defined to require mutual authentication and integrity for at least the \\*\SYSVOL and \\*\NETLOGON shares.

**Rule ID:** `SV-278087r1130302_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 command line data must be included in process creation events.

**Rule ID:** `SV-278088r1129304_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to enable Remote host allows delegation of nonexportable credentials.

**Rule ID:** `SV-278089r1129307_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 virtualization-based security must be enabled with the platform security level configured to Secure Boot or Secure Boot with DMA Protection.

**Rule ID:** `SV-278090r1130164_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Early Launch Antimalware, Boot-Start Driver Initialization Policy must prevent boot drivers identified as bad.

**Rule ID:** `SV-278091r1129313_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 group policy objects must be reprocessed even if they have not changed.

**Rule ID:** `SV-278092r1129316_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 downloading print driver packages over HTTP must be turned off.

**Rule ID:** `SV-278093r1129319_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 printing over HTTP must be turned off.

**Rule ID:** `SV-278094r1129322_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 network selection user interface (UI) must not be displayed on the logon screen.

**Rule ID:** `SV-278095r1129325_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 users must be prompted to authenticate when the system wakes from sleep (on battery).

**Rule ID:** `SV-278096r1129328_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 users must be prompted to authenticate when the system wakes from sleep (plugged in).

**Rule ID:** `SV-278097r1129331_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Application Compatibility Program Inventory must be prevented from collecting data and sending the information to Microsoft.

**Rule ID:** `SV-278098r1129334_rule`
**Severity:** low
...
### Rule: Windows Server 2025 AutoPlay must be turned off for nonvolume devices.

**Rule ID:** `SV-278099r1129337_rule`
**Severity:** high
...
### Rule: Windows Server 2025 default AutoRun behavior must be configured to prevent AutoRun commands.

**Rule ID:** `SV-278100r1129340_rule`
**Severity:** high
...
### Rule: Windows Server 2025 AutoPlay must be disabled for all drives.

**Rule ID:** `SV-278101r1129343_rule`
**Severity:** high
...
### Rule: Windows Server 2025 administrator accounts must not be enumerated during elevation.

**Rule ID:** `SV-278102r1129346_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Telemetry must be configured to send "required diagnostic data" or "optional diagnostic data".

**Rule ID:** `SV-278103r1129349_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Windows Update must not obtain updates from other PCs on the internet.

**Rule ID:** `SV-278104r1129352_rule`
**Severity:** low
...
### Rule: Windows Server 2025 Application event log size must be configured to 32768 KB or greater.

**Rule ID:** `SV-278105r1130166_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Security event log size must be configured to 196608 KB or greater.

**Rule ID:** `SV-278106r1130168_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 System event log size must be configured to 32768 KB or greater.

**Rule ID:** `SV-278107r1130170_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Microsoft Defender antivirus SmartScreen must be enabled.

**Rule ID:** `SV-278108r1130172_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Explorer Data Execution Prevention must be enabled.

**Rule ID:** `SV-278109r1129367_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Turning off File Explorer heap termination on corruption must be disabled.

**Rule ID:** `SV-278110r1129370_rule`
**Severity:** low
...
### Rule: Windows Server 2025 File Explorer shell protocol must run in protected mode.

**Rule ID:** `SV-278111r1129373_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not save passwords in the Remote Desktop Client.

**Rule ID:** `SV-278112r1129376_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Remote Desktop Services must prevent drive redirection.

**Rule ID:** `SV-278113r1129379_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Remote Desktop Services must always prompt a client for passwords upon connection.

**Rule ID:** `SV-278114r1129382_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Remote Desktop Services must require secure Remote Procedure Call (RPC) communications.

**Rule ID:** `SV-278115r1129385_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Remote Desktop Services must be configured with the client connection encryption set to High Level.

**Rule ID:** `SV-278116r1129388_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must prevent attachments from being downloaded from RSS feeds.

**Rule ID:** `SV-278117r1129391_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must disable Basic authentication for RSS feeds over HTTP.

**Rule ID:** `SV-278118r1129394_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must prevent Indexing of encrypted files.

**Rule ID:** `SV-278119r1129397_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must prevent users from changing installation options.

**Rule ID:** `SV-278120r1129400_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must disable the Windows Installer Always install with elevated privileges option.

**Rule ID:** `SV-278121r1129403_rule`
**Severity:** high
...
### Rule: Windows Server 2025 users must be notified if a web-based program attempts to install software.

**Rule ID:** `SV-278122r1129406_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must disable automatically signing in the last interactive user after a system-initiated restart.

**Rule ID:** `SV-278123r1129409_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 PowerShell script block logging must be enabled.

**Rule ID:** `SV-278124r1129412_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Windows Remote Management (WinRM) client must not use Basic authentication.

**Rule ID:** `SV-278125r1129415_rule`
**Severity:** high
...
### Rule: Windows Server 2025 Windows Remote Management (WinRM) client must not allow unencrypted traffic.

**Rule ID:** `SV-278126r1129418_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Windows Remote Management (WinRM) client must not use Digest authentication.

**Rule ID:** `SV-278127r1129421_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Windows Remote Management (WinRM) service must not use Basic authentication.

**Rule ID:** `SV-278128r1129424_rule`
**Severity:** high
...
### Rule: Windows Server 2025 Windows Remote Management (WinRM) service must not allow unencrypted traffic.

**Rule ID:** `SV-278129r1129427_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Windows Remote Management (WinRM) service must not store RunAs credentials.

**Rule ID:** `SV-278130r1130299_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Storage of administrative credentials could allow unauthorized access. Disallowing the storage of RunAs credentials for WinRM will prevent them from being used with plug-ins. Satisfies: SRG-OS-000373-GPOS-00156, SRG-OS-000373-GPOS-00157</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2025 must have PowerShell Transcription enabled.

**Rule ID:** `SV-278131r1129433_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must only allow administrators responsible for the domain controller to have Administrator rights on the system.

**Rule ID:** `SV-278132r1129436_rule`
**Severity:** high
...
### Rule: Windows Server 2025 Kerberos user logon restrictions must be enforced.

**Rule ID:** `SV-278133r1129439_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Kerberos service ticket maximum lifetime must be limited to 600 minutes or less.

**Rule ID:** `SV-278134r1129442_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Kerberos user ticket lifetime must be limited to 10 hours or less.

**Rule ID:** `SV-278135r1129445_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Kerberos policy user ticket renewal maximum lifetime must be limited to seven days or less.

**Rule ID:** `SV-278136r1129448_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 computer clock synchronization tolerance must be limited to five minutes or less.

**Rule ID:** `SV-278137r1129451_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 permissions on the Active Directory data files must only allow system administrators (SAs) access.

**Rule ID:** `SV-278138r1130298_rule`
**Severity:** high
...
### Rule: Windows Server 2025 Active Directory SYSVOL directory must have the proper access control permissions.

**Rule ID:** `SV-278139r1129457_rule`
**Severity:** high
...
### Rule: Windows Server 2025 Active Directory Group Policy objects must have proper access control permissions.

**Rule ID:** `SV-278140r1129460_rule`
**Severity:** high
...
### Rule: Windows Server 2025 Active Directory Domain Controllers Organizational Unit (OU) object must have the proper access control permissions.

**Rule ID:** `SV-278141r1129463_rule`
**Severity:** high
...
### Rule: Windows Server 2025 organization created Active Directory Organizational Unit (OU) objects must have proper access control permissions.

**Rule ID:** `SV-278142r1129466_rule`
**Severity:** high
...
### Rule: Windows Server 2025 data files owned by users must be on a different logical partition from the directory server data files.

**Rule ID:** `SV-278143r1129469_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>When directory service data files, especially for directories used for identification, authentication, or authorization, reside on the same logical partition as user-owned files, the directory service data may be more vulnerable to unauthorized access or other availability compromises. Directory service and user-owned data files sharing a partition may be configured with less restrictive permissions to allow access to the user data. The directory service may be vulnerable to a denial-of-service (DoS) attack when user-owned files on a common partition are expanded to an extent preventing the directory service from acquiring more space for directory or audit data.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2025 domain controllers must run on a machine dedicated to that function.

**Rule ID:** `SV-278144r1130174_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must use separate, NSA-approved (Type 1) cryptography to protect the directory data in transit for directory service implementations at a classified confidentiality level when replication data traverses a network cleared to a lower level than the data.

**Rule ID:** `SV-278145r1129475_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 directory data (outside the root DSE) of a nonpublic directory must be configured to prevent anonymous access.

**Rule ID:** `SV-278146r1129478_rule`
**Severity:** high
...
### Rule: Windows Server 2025 directory service must be configured to terminate LDAP-based network connections to the directory server after five minutes of inactivity.

**Rule ID:** `SV-278147r1129481_rule`
**Severity:** low
...
### Rule: Windows Server 2025 Active Directory Group Policy Objects (GPOs) must be configured with proper audit settings.

**Rule ID:** `SV-278148r1130304_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Active Directory (AD) Domain object must be configured with proper audit settings.

**Rule ID:** `SV-278149r1129487_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Active Directory (AD) Infrastructure object must be configured with proper audit settings.

**Rule ID:** `SV-278150r1129490_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Active Directory (AD) Domain Controllers Organizational Unit (OU) object must be configured with proper audit settings.

**Rule ID:** `SV-278151r1129493_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Active Directory (AD) AdminSDHolder object must be configured with proper audit settings.

**Rule ID:** `SV-278152r1129496_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Active Directory (AD) RID Manager$ object must be configured with proper audit settings.

**Rule ID:** `SV-278153r1129499_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit Account Management - Computer Account Management successes.

**Rule ID:** `SV-278154r1129502_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit DS Access - Directory Service Access successes.

**Rule ID:** `SV-278155r1129505_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit DS Access - Directory Service Access failures.

**Rule ID:** `SV-278156r1129508_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit DS Access - Directory Service Changes successes.

**Rule ID:** `SV-278157r1129511_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to audit DS Access - Directory Service Changes failures.

**Rule ID:** `SV-278158r1129514_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 domain controllers must have a PKI server certificate.

**Rule ID:** `SV-278159r1129517_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 domain Controller PKI certificates must be issued by the DOD PKI or an approved External Certificate Authority (ECA).

**Rule ID:** `SV-278160r1130176_rule`
**Severity:** high
...
### Rule: Windows Server 2025 PKI certificates associated with user accounts must be issued by a DOD PKI or an approved External Certificate Authority (ECA).

**Rule ID:** `SV-278161r1129523_rule`
**Severity:** high
...
### Rule: Windows Server 2025 Active Directory (AD) user accounts, including administrators, must be configured to require the use of a Common Access Card (CAC), Personal Identity Verification (PIV)-compliant hardware token, or Alternate Logon Token (ALT) for user authentication.

**Rule ID:** `SV-278162r1129526_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 domain controllers must require LDAP access signing.

**Rule ID:** `SV-278163r1129529_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Unsigned network traffic is susceptible to man-in-the-middle attacks, where an intruder captures packets between the server and the client and modifies them before forwarding them to the client. In the case of an LDAP server, this means that an attacker could cause a client to make decisions based on false records from the LDAP directory. The risk of an attacker pulling this off can be decreased by implementing strong physical security measures to protect the network infrastructure. Furthermore, implementing Internet Protocol security (IPsec) authentication header (AH) mode, which performs mutual authentication and packet integrity for IP traffic, can make all types of man-in-the-middle attacks extremely difficult. Satisfies: SRG-OS-000423-GPOS-00187, SRG-OS-000424-GPOS-00188</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2025 domain controllers must be configured to allow reset of machine account passwords.

**Rule ID:** `SV-278164r1129532_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Access this computer from the network" user right must only be assigned to the Administrators, Authenticated Users, and Enterprise Domain Controllers groups on domain controllers.

**Rule ID:** `SV-278165r1130179_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Add workstations to domain" user right must only be assigned to the Administrators group on domain controllers.

**Rule ID:** `SV-278166r1130182_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Allow log on through Remote Desktop Services" user right must only be assigned to the Administrators group on domain controllers.

**Rule ID:** `SV-278167r1130185_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Deny access to this computer from the network" user right on domain controllers must be configured to prevent unauthenticated access.

**Rule ID:** `SV-278168r1130188_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Deny log on as a batch job" user right on domain controllers must be configured to prevent unauthenticated access.

**Rule ID:** `SV-278169r1130191_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Deny log on as a service" user right must be configured to include no accounts or groups (blank) on domain controllers.

**Rule ID:** `SV-278170r1130192_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Deny log on locally" user right on domain controllers must be configured to prevent unauthenticated access.

**Rule ID:** `SV-278171r1130195_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured for certificate-based authentication for domain controllers.

**Rule ID:** `SV-278172r1129556_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured for name-based strong mappings for certificates.

**Rule ID:** `SV-278173r1130306_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Deny log on through Remote Desktop Services" user right on domain controllers must be configured to prevent unauthenticated access.

**Rule ID:** `SV-278174r1130200_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Enable computer and user accounts to be trusted for delegation" user right must only be assigned to the Administrators group on domain controllers.

**Rule ID:** `SV-278175r1130203_rule`
**Severity:** medium
...
**Rule ID:** `SV-278176r1130205_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must only allow administrators responsible for the member server or standalone or nondomain joined system to have Administrator rights on the system.

**Rule ID:** `SV-278177r1129571_rule`
**Severity:** high
...
### Rule: Windows Server 2025 local administrator accounts must have their privileged token filtered to prevent elevated privileges from being used over the network on domain-joined member servers.

**Rule ID:** `SV-278178r1130207_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 local users on domain-joined member servers must not be enumerated.

**Rule ID:** `SV-278179r1130209_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must restrict unauthenticated Remote Procedure Call (RPC) clients from connecting to the RPC server on domain-joined member servers and standalone or nondomain joined systems.

**Rule ID:** `SV-278180r1129580_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must limit the caching of logon credentials to four or less on domain-joined member servers.

**Rule ID:** `SV-278181r1130211_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must restrict remote calls to the Security Account Manager (SAM) to Administrators on domain-joined member servers and standalone or nondomain joined systems.

**Rule ID:** `SV-278182r1129586_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Access this computer from the network user right must only be assigned to the Administrators and Authenticated Users groups on domain-joined member servers and standalone or nondomain joined systems.

**Rule ID:** `SV-278183r1130214_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Deny access to this computer from the network" user right on domain-joined member servers must be configured to prevent access from highly privileged domain accounts and local accounts and from unauthenticated access on all systems.

**Rule ID:** `SV-278184r1129592_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Deny log on as a batch job user right on domain-joined member servers must be configured to prevent access from highly privileged domain accounts and from unauthenticated access on all systems.

**Rule ID:** `SV-278185r1129595_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Deny log on as a service" user right on domain-joined member servers must be configured to prevent access from highly privileged domain accounts. No other groups or accounts must be assigned this right.

**Rule ID:** `SV-278186r1130216_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Deny log on locally" user right on domain-joined member servers must be configured to prevent access from highly privileged domain accounts and from unauthenticated access on all systems.

**Rule ID:** `SV-278187r1129601_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Deny log on through Remote Desktop Services" user right on domain-joined member servers must be configured to prevent access from highly privileged domain accounts and all local accounts and from unauthenticated access on all systems.

**Rule ID:** `SV-278188r1129604_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Enable computer and user accounts to be trusted for delegation" user right must not be assigned to any groups or accounts on domain-joined member servers and standalone or nondomain joined systems.

**Rule ID:** `SV-278189r1129607_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be running Credential Guard on domain-joined member servers.

**Rule ID:** `SV-278190r1130308_rule`
**Severity:** high
...
### Rule: The operating system must prohibit the use of cached authenticators after one day.

**Rule ID:** `SV-278191r1130219_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the DOD Root Certificate Authority (CA) certificates installed in the Trusted Root Store.

**Rule ID:** `SV-278192r1129616_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the DOD Interoperability Root Certificate Authority (CA) cross-certificates installed in the Untrusted Certificates Store on unclassified systems.

**Rule ID:** `SV-278193r1129619_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the US DOD CCEB Interoperability Root CA cross-certificates in the Untrusted Certificates Store on unclassified systems.

**Rule ID:** `SV-278194r1129622_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must have the built-in guest account disabled.

**Rule ID:** `SV-278195r1129625_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must prevent local accounts with blank passwords from being used from the network.

**Rule ID:** `SV-278196r1129628_rule`
**Severity:** high
...
### Rule: The Windows Server 2025 built-in administrator account must be renamed.

**Rule ID:** `SV-278197r1129631_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 built-in guest account must be renamed.

**Rule ID:** `SV-278198r1129634_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must force audit policy subcategory settings to override audit policy category settings.

**Rule ID:** `SV-278199r1129637_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 setting Domain member: Digitally encrypt or sign secure channel data (always) must be configured to Enabled.

**Rule ID:** `SV-278200r1129640_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 setting Domain member: Digitally encrypt secure channel data (when possible) must be configured to Enabled.

**Rule ID:** `SV-278201r1129643_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 setting Domain member: Digitally sign secure channel data (when possible) must be configured to Enabled.

**Rule ID:** `SV-278202r1129646_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 computer account password must not be prevented from being reset.

**Rule ID:** `SV-278203r1129649_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 maximum age for machine account passwords must be configured to 30 days or less.

**Rule ID:** `SV-278204r1129652_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to require a strong session key.

**Rule ID:** `SV-278205r1129655_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 machine inactivity limit must be set to 15 minutes or less, locking the system with the screen saver.

**Rule ID:** `SV-278206r1129658_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 required legal notice must be configured to display before console logon.

**Rule ID:** `SV-278207r1129661_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 title for legal banner dialog box must be configured with the appropriate text.

**Rule ID:** `SV-278208r1129664_rule`
**Severity:** low
...
### Rule: The Windows Server 2025 Smart Card removal option must be configured to Force Logoff or Lock Workstation.

**Rule ID:** `SV-278209r1129667_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 setting Microsoft network client: Digitally sign communications (always) must be configured to Enabled.

**Rule ID:** `SV-278210r1129670_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 setting Microsoft network client: Digitally sign communications (if server agrees) must be configured to Enabled.

**Rule ID:** `SV-278211r1129673_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 unencrypted passwords must not be sent to third-party Server Message Block (SMB) servers.

**Rule ID:** `SV-278212r1129676_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 setting Microsoft network server: Digitally sign communications (always) must be configured to Enabled.

**Rule ID:** `SV-278213r1129679_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 setting Microsoft network server: Digitally sign communications (if client agrees) must be configured to Enabled.

**Rule ID:** `SV-278214r1129682_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must not allow anonymous SID/Name translation.

**Rule ID:** `SV-278215r1129685_rule`
**Severity:** high
...
### Rule: Windows Server 2025 must not allow anonymous enumeration of Security Account Manager (SAM) accounts.

**Rule ID:** `SV-278216r1129688_rule`
**Severity:** high
...
### Rule: Windows Server 2025 must not allow anonymous enumeration of shares.

**Rule ID:** `SV-278217r1129691_rule`
**Severity:** high
...
### Rule: Windows Server 2025 must be configured to prevent anonymous users from having the same permissions as the Everyone group.

**Rule ID:** `SV-278218r1129694_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must restrict anonymous access to Named Pipes and Shares.

**Rule ID:** `SV-278219r1129697_rule`
**Severity:** high
...
### Rule: Windows Server 2025 services using Local System that use Negotiate when reverting to NTLM authentication must use the computer identity instead of authenticating anonymously.

**Rule ID:** `SV-278220r1129700_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must prevent NTLM from falling back to a Null session.

**Rule ID:** `SV-278221r1129703_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must prevent PKU2U authentication using online identities.

**Rule ID:** `SV-278222r1129706_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 Kerberos encryption types must be configured to prevent the use of DES and RC4 encryption suites.

**Rule ID:** `SV-278223r1129709_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to prevent the storage of the LAN Manager hash of passwords.

**Rule ID:** `SV-278224r1129712_rule`
**Severity:** high
...
### Rule: Windows Server 2025 LAN Manager authentication level must be configured to send NTLMv2 response only and to refuse LM and NTLM.

**Rule ID:** `SV-278225r1129715_rule`
**Severity:** high
...
### Rule: Windows Server 2025 must be configured to at least negotiate signing for LDAP client signing.

**Rule ID:** `SV-278226r1129718_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 session security for NTLM SSP-based clients must be configured to require NTLMv2 session security and 128-bit encryption.

**Rule ID:** `SV-278227r1129721_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 session security for NTLM SSP-based servers must be configured to require NTLMv2 session security and 128-bit encryption.

**Rule ID:** `SV-278228r1129724_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 users must be required to enter a password to access private keys stored on the computer.

**Rule ID:** `SV-278229r1129727_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must be configured to use FIPS-compliant algorithms for encryption, hashing, and signing.

**Rule ID:** `SV-278230r1129730_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>This setting ensures the system uses FIPS-compliant algorithms for encryption, hashing, and signing. FIPS-compliant algorithms meet specific standards established by the U.S. Government and must be the algorithms used for all OS encryption functions.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: Windows Server 2025 default permissions of global system objects must be strengthened.

**Rule ID:** `SV-278231r1129733_rule`
**Severity:** low
...
### Rule: Windows Server 2025 User Account Control (UAC) approval mode for the built-in Administrator must be enabled.

**Rule ID:** `SV-278232r1129736_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 UIAccess applications must not be allowed to prompt for elevation without using the secure desktop.

**Rule ID:** `SV-278233r1129739_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 User Account Control (UAC) must, at a minimum, prompt administrators for consent on the secure desktop.

**Rule ID:** `SV-278234r1129742_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 User Account Control (UAC) must automatically deny standard user requests for elevation.

**Rule ID:** `SV-278235r1129745_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 User Account Control (UAC) must be configured to detect application installations and prompt for elevation.

**Rule ID:** `SV-278236r1129748_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 User Account Control (UAC) must only elevate UIAccess applications that are installed in secure locations.

**Rule ID:** `SV-278237r1129751_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 User Account Control (UAC) must run all administrators in Admin Approval Mode, enabling UAC.

**Rule ID:** `SV-278238r1129754_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 User Account Control (UAC) must virtualize file and registry write failures to per-user locations.

**Rule ID:** `SV-278239r1129757_rule`
**Severity:** medium
...
### Rule: Windows Server 2025 must preserve zone information when saving attachments.

**Rule ID:** `SV-278240r1129760_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Access Credential Manager as a trusted caller" user right must not be assigned to any groups or accounts.

**Rule ID:** `SV-278241r1129763_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Act as part of the operating system" user right must not be assigned to any groups or accounts.

**Rule ID:** `SV-278242r1129766_rule`
**Severity:** high
...
### Rule: The Windows Server 2025 "Allow log on locally" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278243r1130222_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Back up files and directories" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278244r1130225_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Create a pagefile" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278245r1130228_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Create a token object" user right must not be assigned to any groups or accounts.

**Rule ID:** `SV-278246r1129778_rule`
**Severity:** high
...
### Rule: The Windows Server 2025 "Create global objects" user right must only be assigned to Administrators, Service, Local Service, and Network Service.

**Rule ID:** `SV-278247r1130231_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Create permanent shared objects" user right must not be assigned to any groups or accounts.

**Rule ID:** `SV-278248r1130232_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Create symbolic links" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278249r1130235_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Debug programs" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278250r1130238_rule`
**Severity:** high
...
### Rule: The Windows Server 2025 "Force shutdown from a remote system" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278251r1130241_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Generate security audits" user right must only be assigned to Local Service and Network Service.

**Rule ID:** `SV-278252r1130244_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Impersonate a client after authentication" user right must only be assigned to Administrators, Service, Local Service, and Network Service.

**Rule ID:** `SV-278253r1130247_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Increase scheduling priority" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278254r1130250_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Load and unload device drivers" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278255r1130253_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Lock pages in memory" user right must not be assigned to any groups or accounts.

**Rule ID:** `SV-278256r1130254_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Manage auditing and security log" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278257r1130257_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Modify firmware environment values" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278258r1130260_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Perform volume maintenance tasks" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278259r1130263_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Profile single process" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278260r1130266_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Restore files and directories" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278261r1130269_rule`
**Severity:** medium
...
### Rule: The Windows Server 2025 "Take ownership of files or other objects" user right must only be assigned to the Administrators group.

**Rule ID:** `SV-278262r1130272_rule`
**Severity:** medium
