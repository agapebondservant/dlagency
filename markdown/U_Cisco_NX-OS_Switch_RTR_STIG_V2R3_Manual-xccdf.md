# STIG Benchmark: Cisco NX OS Switch RTR Security Technical Implementation Guide
...
### Rule: The Cisco switch must be configured to implement message authentication for all control plane protocols.

**Rule ID:** `SV-221072r856658_rule`
**Severity:** medium
...
### Rule: The Cisco switch must be configured to use keys with a duration not exceeding 180 days for authenticating routing protocol messages.

**Rule ID:** `SV-221073r856660_rule`
**Severity:** medium
...
### Rule: The Cisco switch must be configured to use encryption for routing protocol authentication.
...
### Rule: The Cisco switch must be configured to authenticate all routing protocol messages using NIST-validated FIPS 198-1 message authentication code algorithm.
...
### Rule: The Cisco switch must be configured to have all non-essential capabilities disabled.
...
### Rule: The Cisco switch must not be configured to have any feature enabled that calls home to the vendor.

**Rule ID:** `SV-221078r856655_rule`
**Severity:** medium
...
### Rule: The Cisco switch must be configured to restrict traffic destined to itself.
...
### Rule: The Cisco switch must be configured to drop all fragmented Internet Control Message Protocol (ICMP) packets destined to itself.
...
### Rule: The Cisco BGP switch must be configured to check whether a single-hop eBGP peer is directly connected.

**Rule ID:** `SV-221101r856661_rule`
**Severity:** low
