...
### Rule: Users must not reuse the last 5 passwords.
...
### Rule: The operating system must terminate all sessions and network connections when non-local maintenance is completed.
