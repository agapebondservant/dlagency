...
### Rule: The IBM z/OS operating system must enforce a minimum eight-character password length.
...
### Rule: The CA-TSS PTHRESH Control Option must be properly set.
...
### Rule: The IBM z/OS warning banner for the FTP server must be properly specified.
...
### Rule: The IBM z/OS System Administrator must develop a process to notify appropriate personnel when accounts are created.
...
### Rule: The IBM z/OS System Administrator must develop a process to notify appropriate personnel when accounts are modified.
...
### Rule: The IBM z/OS System Administrator must develop a process to notify appropriate personnel when accounts are deleted.
...
### Rule: The IBM z/OS System Administrator must develop a process to notify appropriate personnel when accounts are removed.
...
### Rule: IBM z/OS must employ a session manager to initiate a session lock after a 15-minute period of inactivity for all connection types.
...
### Rule: IBM z/OS DFSMS control data sets must be properly protected.
