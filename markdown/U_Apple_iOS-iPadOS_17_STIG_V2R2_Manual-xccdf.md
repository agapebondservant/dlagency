# STIG Benchmark: Apple iOS/iPadOS 17 Security Technical Implementation Guide
...
### Rule: Apple iOS/iPadOS 17 must allow the Administrator (MDM) to perform the following management function: enable/disable VPN protection across the device and [selection: other methods].

**Rule ID:** `SV-258310r959010_rule`
**Severity:** low
...
**Rule ID:** `SV-258320r1015680_rule`
**Severity:** medium
...
**Rule ID:** `SV-258321r1015681_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must not include applications with the following characteristics: access to Siri when the device is locked.

**Rule ID:** `SV-258327r1032950_rule`
**Severity:** medium
...
### Rule: Apple iPadOS 17 must be configured to disable multiuser modes.

**Rule ID:** `SV-258334r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must be configured to disable ad hoc wireless client-to-client connection capability.

**Rule ID:** `SV-258337r987886_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: limit Ad Tracking.

**Rule ID:** `SV-258339r959010_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: not allow automatic completion of Safari browser passcodes.

**Rule ID:** `SV-258340r959010_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: not allow use of Handoff.

**Rule ID:** `SV-258342r959010_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: not allow use of iPhone widgets on Mac.

**Rule ID:** `SV-258343r959010_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: Disable Allow MailDrop.

**Rule ID:** `SV-258346r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: not have any Family Members in Family Sharing.

**Rule ID:** `SV-258351r959010_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: not share location data through iCloud.

**Rule ID:** `SV-258352r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: enable USB Restricted Mode.

**Rule ID:** `SV-258356r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: disable AirDrop.

**Rule ID:** `SV-258359r959010_rule`
**Severity:** low
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: disable paired Apple Watch.

**Rule ID:** `SV-258360r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must implement the management setting: approved Apple Watches must be managed by an MDM.

**Rule ID:** `SV-258361r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must disable "Password AutoFill" in browsers and applications.

**Rule ID:** `SV-258362r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must disable allow setting up new nearby devices.

**Rule ID:** `SV-258363r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must disable password proximity requests.

**Rule ID:** `SV-258364r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must disable password sharing.

**Rule ID:** `SV-258365r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must disable "Find My Friends" in the "Find My" app.

**Rule ID:** `SV-258366r959010_rule`
**Severity:** low

**Description:**
<VulnDiscussion>This control does not share a DOD user's location but encourages location sharing between DOD mobile device users, which can lead to operational security (OPSEC) risks. Sharing the location of a DOD mobile device is a violation of AIOS-17-011700. SFR ID: FMT_SMF_EXT.1.1 #47</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
### Rule: The Apple iOS/iPadOS 17 must be supervised by the MDM.

**Rule ID:** `SV-258367r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must disable "Allow network drive access in Files access".

**Rule ID:** `SV-258371r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must disable connections to Siri servers for the purpose of dictation.

**Rule ID:** `SV-258372r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must disable connections to Siri servers for the purpose of translation.

**Rule ID:** `SV-258373r959010_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must be configured to disable "Auto Unlock" of the iPhone by an Apple Watch.

**Rule ID:** `SV-258376r1015682_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must not allow backup to remote systems (iCloud).

**Rule ID:** `SV-259186r958524_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must not allow backup to remote systems (iCloud document and data synchronization).
...
### Rule: Apple iOS/iPadOS 17 must not allow backup to remote systems (iCloud Keychain).

**Rule ID:** `SV-259188r958524_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must not allow backup to remote systems (Cloud Photo Library).

**Rule ID:** `SV-259189r958524_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must not allow backup to remote systems (iCloud Photo Sharing, also known as Shared Stream or Shared Photo Stream).

**Rule ID:** `SV-259190r958524_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must disable "Allow USB drive access in Files app" if the authorizing official (AO) has not approved the use of DOD-approved USB storage drives with iOS/iPadOS devices.

**Rule ID:** `SV-259193r958524_rule`
**Severity:** medium
...
### Rule: All Apple iOS/iPadOS 17 installations must be removed.

**Rule ID:** `SV-274438r1099866_rule`
**Severity:** high

**Description:**
<VulnDiscussion>Apple iOS/iPadOS 17 is no longer supported by Apple and therefore, may contain security vulnerabilities. SFR ID: FMT_SMF_EXT.1.1 #47</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>

**Check Text:**
Verify there are no installations of Apple iOS/iPadOS 17 at the site. If Apple iOS/iPadOS 17 is being used at the site, this is a finding.
