# STIG Benchmark: Tanium 7.x Security Technical Implementation Guide
...
### Rule: The Tanium application must be configured to send audit records from multiple components within the system to a central location for review and analysis.

**Rule ID:** `SV-253779r997220_rule`
**Severity:** medium
...
**Rule ID:** `SV-253781r1099925_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Similar to any other host-based applications, the Tanium Client is subject to the restrictions other system-level software may place on an operating environment. Antivirus, intrusion prevention system (IPS), encryption, or other security and management stack software may disallow the Client from working as expected.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
**Rule ID:** `SV-253786r1067649_rule`
**Severity:** medium
...
**Rule ID:** `SV-253787r1099927_rule`
**Severity:** medium
...
**Check Text:**
1. Using a web browser on a system that has connectivity to the Tanium application, access the Tanium application web user interface (UI) and log on with multifactor authentication. 2. Click "Administration" on the top navigation banner. 3. Under "Configuration", select "Bandwidth Throttles". 4. Work with the Tanium administrator to confirm settings. If the Bandwidth Throttles configuration is not accordance with organization's needs, this is a finding.

## Group: SRG-APP-000266

**Group ID:** `V-253788`

### Rule: The Tanium application must generate error messages that provide information necessary for corrective actions without revealing information that could be exploited by adversaries.

**Rule ID:** `SV-253788r997229_rule`
**Severity:** medium
...
### Rule: The Tanium application must reveal error messages only to the information system security officer (ISSO), information system security manager (ISSM), and system administrator (SA).

**Rule ID:** `SV-253789r997230_rule`
**Severity:** medium
...
### Rule: The Tanium application must provide an immediate warning to the system administrator and information system security officer (at a minimum) when allocated audit record storage volume reaches 75% of repository maximum audit record storage capacity.

**Rule ID:** `SV-253793r997233_rule`
**Severity:** medium
...
### Rule: The Tanium application must provide an immediate real-time alert to the system administrator and information system security officer, at a minimum, of all audit failure events requiring real-time alerts.

**Rule ID:** `SV-253794r1099929_rule`
**Severity:** medium
...
**Rule ID:** `SV-253795r1015837_rule`
**Severity:** medium
...
### Rule: The application must employ a deny-all, permit-by-exception (allowlist) policy to allow the execution of authorized software programs.

**Rule ID:** `SV-253797r997236_rule`
**Severity:** medium
...
### Rule: The Tanium application must accept Personal Identity Verification (PIV) credentials.

**Rule ID:** `SV-253798r997237_rule`
**Severity:** medium
...
### Rule: The Tanium application must electronically verify Personal Identity Verification (PIV) credentials.

**Rule ID:** `SV-253799r997238_rule`
**Severity:** medium
...
### Rule: The Tanium application must accept Personal Identity Verification (PIV) credentials from other federal agencies.

**Rule ID:** `SV-253800r1099931_rule`
**Severity:** medium
...
### Rule: Tanium Server processes must be excluded from On-Access scan.

**Rule ID:** `SV-253803r1099932_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Similar to any other host-based applications, the Tanium Server is subject to the restrictions other system-level software may place on an operating environment. Antivirus, intrusion prevention system (IPS), encryption, or other security and management stack software may disallow the Tanium Server from working as expected.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
## Group: SRG-APP-000580

**Group ID:** `V-253804`

### Rule: The Tanium application must authenticate endpoint devices (servers) before establishing a local, remote, and/or network connection using bidirectional authentication that is cryptographically based.

**Rule ID:** `SV-253804r1067652_rule`
**Severity:** medium
...
**Check Text:**
1. Using a web browser on a system that has connectivity to the Tanium application, access the Tanium application web user interface (UI) and log on with multifactor authentication. 2. Click "Administration" on the top navigation banner. 3. Under "Configuration", select "Settings". 4. Click the "Advanced Settings" tab. 5. In the "Filter items" search box, type "TLSMode" and "ReportingTLSMode". 6. Click "Enter". If results are returned and "TLSMode" = 0 and "ReportingTLSMode" = 0, this is a finding.

## Group: SRG-APP-000015

**Group ID:** `V-253805`

### Rule: The Tanium endpoint must have the Tanium Server's pki.db in its installation.

**Rule ID:** `SV-253805r960762_rule`
**Severity:** medium
...
**Rule ID:** `SV-253807r1067655_rule`
**Severity:** medium
...
**Rule ID:** `SV-253808r1043177_rule`
**Severity:** medium
...
**Rule ID:** `SV-253812r1099933_rule`
**Severity:** medium
...
### Rule: Tanium endpoint files must be excluded from host-based intrusion prevention system (HIPS) intervention.

**Rule ID:** `SV-253813r1099934_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Similar to any other host-based applications, the Tanium Client is subject to the restrictions other system-level software may place on an operating environment. Antivirus, intrusion prevention system (IPS), encryption, or other security and management stack software may disallow the Tanium Server from working as expected.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
**Rule ID:** `SV-253814r1099936_rule`
**Severity:** medium
...
**Rule ID:** `SV-253815r1099938_rule`
**Severity:** medium
...
**Rule ID:** `SV-253816r1099940_rule`
**Severity:** medium
...
### Rule: Tanium Computer Groups must be used to restrict console users from effecting changes to unauthorized computers.

**Rule ID:** `SV-253817r1099942_rule`
**Severity:** medium
...
### Rule: The Tanium application must be configured to use Tanium User Groups in a manner consistent with the model outlined in the environment's system documentation.

**Rule ID:** `SV-253819r997255_rule`
**Severity:** medium
...
### Rule: Multifactor authentication must be enabled on the Tanium Server for network access with privileged accounts.

**Rule ID:** `SV-253821r1099944_rule`
**Severity:** high
...
### Rule: The Tanium application must alert the information system security officer and system administrator (at a minimum) in the event of an audit processing failure.

**Rule ID:** `SV-253824r997258_rule`
**Severity:** medium
...
### Rule: Tanium must notify system administrator and information system security officer (ISSO) when accounts are created.

**Rule ID:** `SV-253825r1015841_rule`
**Severity:** medium
...
### Rule: Tanium must notify system administrators and the information system security officer (ISSO) when accounts are modified.

**Rule ID:** `SV-253826r1015842_rule`
**Severity:** medium
...
### Rule: Tanium must notify the system administrator and information system security officer (ISSO) of account enabling actions.

**Rule ID:** `SV-253827r1015843_rule`
**Severity:** medium
...
**Rule ID:** `SV-253828r1099947_rule`
**Severity:** medium
...
### Rule: Tanium must notify system administrators and the information system security officer (ISSO) for account disabling actions.

**Rule ID:** `SV-253829r1015845_rule`
**Severity:** medium
...
### Rule: Tanium must notify system administrators and the information system security officer (ISSO) for account removal actions.

**Rule ID:** `SV-253830r1015846_rule`
**Severity:** medium
...
**Rule ID:** `SV-253832r1099949_rule`
**Severity:** medium
...
**Rule ID:** `SV-253834r1015847_rule`
**Severity:** medium
...
### Rule: The Tanium Server installer's account database permissions must be reduced to an appropriate level.

**Rule ID:** `SV-253835r1015848_rule`
**Severity:** medium
...
**Description:**
<VulnDiscussion>The Tanium Server can use either a SQL Server relational database management system (RDBMS) installed locally to the same device as the Tanium Server application or a remote dedicated or shared SQL Server instance. Using a local SQL Server database typically requires no changes to network firewall rules since all communication remains on the Tanium application server device. To access database resources installed to a remote device, however, the Tanium Server service communicates over the port reserved for SQL, by default port 1433, to the database. Port Needed: Tanium Server to Remote SQL Server over TCP port 1433. Network firewall rules: Allow TCP traffic on port 1433 from the Tanium Server device to the remote device hosting the SQL Server RDBMS.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
**Rule ID:** `SV-253837r1067658_rule`
**Severity:** medium
...
**Rule ID:** `SV-253841r1067661_rule`
**Severity:** medium
...
### Rule: The Tanium documentation identifying recognized and trusted indicator of compromise (IOC) streams must be maintained.
...
### Rule: The Tanium applications must be configured to filter audit records for events of interest based on organization-defined criteria.
...
**Rule ID:** `SV-253845r1067664_rule`
**Severity:** medium
...
**Check Text:**
1. Using a web browser on a system that has connectivity to the Tanium application, access the Tanium application web user interface (UI) and log on with multifactor authentication. 2. Click "Administration" on the top navigation banner. 3. Under "Configuration", select "Settings". 4. Click the "Advanced Settings" tab. 5. In the "Filter Items" search box, type "sign_all_questions_flag". 6. Click "Enter". If no results are returned, this is a finding. If results are returned for "sign_all_questions_flag" but the value is not "1", this is a finding.

## Group: SRG-APP-000131

**Group ID:** `V-253846`

### Rule: The Tanium Server must be configured to allow only signed content to be imported.

**Rule ID:** `SV-253846r1067667_rule`
**Severity:** medium
...
**Rule ID:** `SV-253848r1099951_rule`
**Severity:** medium
...
### Rule: The Tanium Application Server must be configured to prohibit or restrict the use of organization-defined functions, ports, protocols, and/or services, as defined in the PPSM Category Assurance List (CAL) and vulnerability assessments.

**Rule ID:** `SV-253850r1043177_rule`
**Severity:** medium
...
### Rule: The Tanium Server http directory and subdirectories must be restricted with appropriate permissions.

**Rule ID:** `SV-253853r997275_rule`
**Severity:** medium
...
**Rule ID:** `SV-253857r1099954_rule`
**Severity:** medium
...
### Rule: The Tanium Server certificate must be signed by a DoD certificate authority (CA).
...
### Rule: Tanium Server directory and subsequent files must be excluded from On-Access scan.

**Rule ID:** `SV-253861r1099955_rule`
**Severity:** medium
...
**Rule ID:** `SV-253863r1067670_rule`
**Severity:** medium
...
### Rule: The Tanium Threat Response Local Directory Source must be configured to restrict access to only authorized maintainers of threat intel.

**Rule ID:** `SV-253866r997288_rule`
**Severity:** medium
...
### Rule: The Tanium documentation identifying recognized and trusted Security Content Automation Protocol (SCAP) sources must be maintained.

**Rule ID:** `SV-253867r997289_rule`
**Severity:** medium
...
### Rule: The Tanium documentation identifying recognized and trusted Open Vulnerability and Assessment Language (OVAL) feeds must be maintained.

**Rule ID:** `SV-253868r997290_rule`
**Severity:** medium
...
### Rule: Tanium Comply must be configured to receive Security Content Automation Protocol (SCAP) content only from trusted sources.

**Rule ID:** `SV-253869r997291_rule`
**Severity:** medium
...
### Rule: Tanium Comply must be configured to receive Open Vulnerability and Assessment Language (OVAL) feeds only from trusted sources.

**Rule ID:** `SV-253870r997292_rule`
**Severity:** medium
...
**Rule ID:** `SV-253871r1099957_rule`
**Severity:** medium
...
**Check Text:**
1. Using a web browser on a system that has connectivity to the Tanium application, access the Tanium application web user interface (UI) and log on with multifactor authentication. 2. Click "Administration" on the top navigation banner. 3. Under "Configuration", select "Bandwidth Throttles". 4. Work with the Tanium administrator to confirm settings. If settings are not based on organization needs, this is a finding.
...
**Rule ID:** `SV-253872r1082009_rule`
**Severity:** medium

**Description:**
<VulnDiscussion>Similar to any other host-based applications, the Tanium Server is subject to the restrictions other system-level software may place on an operating environment. Antivirus, intrusion prevention system (IPS), encryption, or other security and management stack software may disallow the Tanium Server from working as expected. For more information, refer to vendor documentation on security exclusions.</VulnDiscussion><FalsePositives></FalsePositives><FalseNegatives></FalseNegatives><Documentable>false</Documentable><Mitigations></Mitigations><SeverityOverrideGuidance></SeverityOverrideGuidance><PotentialImpacts></PotentialImpacts><ThirdPartyTools></ThirdPartyTools><MitigationControl></MitigationControl><Responsibility></Responsibility><IAControls></IAControls>
...
**Rule ID:** `SV-253873r1043182_rule`
**Severity:** medium
...
### Rule: The Tanium application service must be protected from being stopped by a nonprivileged user.

**Rule ID:** `SV-253874r997296_rule`
**Severity:** medium
...
### Rule: The SchUseStrongCrypto registry value must be set.

**Rule ID:** `SV-253876r997298_rule`
**Severity:** high
...
### Rule: The SSLCipherSuite registry value must be set.

**Rule ID:** `SV-253877r997299_rule`
**Severity:** high
