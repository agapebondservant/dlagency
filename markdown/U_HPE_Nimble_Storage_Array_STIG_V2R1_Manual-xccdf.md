...
### Rule: The HPE Nimble must enforce password complexity by requiring that at least one uppercase character be used.

**Rule ID:** `SV-252191r997772_rule`
**Severity:** medium
...
### Rule: The HPE Nimble must enforce password complexity by requiring that at least one lowercase character be used.

**Rule ID:** `SV-252192r997774_rule`
**Severity:** medium
...
**Rule ID:** `SV-252198r1001013_rule`
**Severity:** medium
...
**Rule ID:** `SV-252202r1001011_rule`
**Severity:** medium
