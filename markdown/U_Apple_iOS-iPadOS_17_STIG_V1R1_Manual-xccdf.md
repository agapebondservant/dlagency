...
### Rule: Apple iOS/iPadOS 17 must [selection: wipe protected data, wipe sensitive data] upon unenrollment from MDM.

**Rule ID:** `SV-258318r927637_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must [selection: remove Enterprise application, remove all noncore applications (any nonfactory-installed application)] upon unenrollment from MDM.

**Rule ID:** `SV-258319r927640_rule`
**Severity:** medium
...
### Rule: Apple iOS/iPadOS 17 must be configured to enable a screen-lock policy that will lock the display after a period of inactivity.

**Rule ID:** `SV-258322r927649_rule`
**Severity:** medium
